...
Ljade_kem_mlkem_mlkem768_amd64_ref_dec$250:
	...
	addl	$512, %r10d
	shrl	$10, %r10d
	movw	%r10w, 2(%rsi,%r8,2)
	imull	$3329, %ebx, %r10d
	addl	$512, %r10d
	shrl	$10, %r10d
	movw	%r10w, 4(%rsi,%r8,2)
	imull	$3329, %ebp, %r10d
	addl	$512, %r10d
	shrl	$10, %r10d
...
Ljade_kem_mlkem_mlkem768_amd64_ref_dec$4:
	movzwq	10760(%rsp,%rsi,2), %rcx
	shlq	$10, %rcx
	addq	$1665, %rcx
	imulq	$1290167, %rcx, %rcx
	shrq	$32, %rcx
	andq	$1023, %rcx
	movzwq	10762(%rsp,%rsi,2), %r8
	shlq	$10, %r8
	addq	$1665, %r8
	imulq	$1290167, %r8, %r8
	shrq	$32, %r8
	andq	$1023, %r8
	movzwq	10764(%rsp,%rsi,2), %r9
	shlq	$10, %r9
	addq	$1665, %r9
	imulq	$1290167, %r9, %r9
	shrq	$32, %r9
	andq	$1023, %r9
	movzwq	10766(%rsp,%rsi,2), %r10
	shlq	$10, %r10
	addq	$1665, %r10
...
Ljade_kem_mlkem_mlkem768_amd64_ref_enc_derand$3:
	...
	shrq	$32, %rcx
	andq	$1023, %rcx
	movzwq	9546(%rsp,%rsi,2), %r8
	shlq	$10, %r8
	addq	$1665, %r8
	imulq	$1290167, %r8, %r8
	shrq	$32, %r8
	andq	$1023, %r8
	movzwq	9548(%rsp,%rsi,2), %r9
	shlq	$10, %r9
	addq	$1665, %r9
	imulq	$1290167, %r9, %r9
	shrq	$32, %r9
	andq	$1023, %r9
	movzwq	9550(%rsp,%rsi,2), %r10
	shlq	$10, %r10
	addq	$1665, %r10
	imulq	$1290167, %r10, %r10
	shrq	$32, %r10
