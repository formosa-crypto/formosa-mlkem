...
require import
Array4 Array5 Array20 Array24 Array25 Array32 Array33 Array34 Array40 Array64
Array128 Array168 Array200 Array256 Array384 Array512 Array768 Array960
Array1088 Array1152 Array1184 Array1536 Array2304 Array2400 Array4608
WArray192 WArray256 BArray20 BArray32 BArray33 BArray34 BArray40 BArray64
BArray128 BArray168 BArray192 BArray200 BArray256 BArray384 BArray512
BArray960 BArray1088 BArray1152 BArray1184 BArray1536 BArray2400 BArray4608
SBArray64_32 SBArray2400_32 SBArray256_128 SBArray1088_128 SBArray1152_384
SBArray1536_512 SBArray4608_512 SBArray1088_960 SBArray1184_1152
SBArray2400_1152 SBArray2400_1184 SBArray4608_1536.
...
module M(SC:Syscall_t) = {
  ...
  proc a1088____a_ilen_read_upto8_at (buf:BArray1088.t, b_buf:BArray1088.t,
                                      offset:int, dELTA:int, lEN:int,
    ...
    var param_8:W64.t;
    var result_3:W64.t;
    var trace_a1088____a_ilen_read_upto8_at:trace;
    trace_a1088____a_ilen_read_upto8_at <- [];
    trace_a1088____a_ilen_read_upto8_at <-
    (trace_a1088____a_ilen_read_upto8_at ++
    [(Assert,
     (((0 <= dELTA) /\ (dELTA <= 18446744073709551615)) /\
     ...
     (((0 <= ((offset + dELTA) + ((lEN < 8) ? lEN : 8))) /\
      (((offset + dELTA) + ((lEN < 8) ? lEN : 8)) <= 18446744073709551615)) /\
     ((((((BArray1088.is_init b_buf (offset + dELTA) ((lEN < 8) ? lEN : 8)) /\
         (0 <= dELTA)) /\
        (0 <= offset)) /\
       (((offset + dELTA) + ((lEN < 8) ? lEN : 8)) <= 1088)) /\
      (0 <= tRAIL)) /\
     (tRAIL < 256)))))))))]);
    trace_a1088____a_ilen_read_upto8_at <-
    (trace_a1088____a_ilen_read_upto8_at ++
    ...
    if ((((aT < cUR) \/ ((cUR + 8) <= aT)) \/ ((lEN = 0) /\ (tRAIL = 0)))) {
      ...
      if ((8 <= lEN)) {
        ...
        (trace_a1088____a_ilen_read_upto8_at ++
        [(Assert,
         ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 8) <= 1088)))]);
        trace_a1088____a_ilen_read_upto8_at <-
        (trace_a1088____a_ilen_read_upto8_at ++
        [(Assert, (BArray1088.is_init b_buf (offset + dELTA) 8))]);
        w <- (BArray1088.get64d buf (offset + dELTA));
        param_0 <- w;
        param <- aT8;
        (result, tmp__trace) <@ __SHLQ (param_0, param);
        trace_a1088____a_ilen_read_upto8_at <-
        (trace_a1088____a_ilen_read_upto8_at ++ tmp__trace);
        w <- result;
        dELTA <- (dELTA + (8 - aT8));
        lEN <- (lEN - (8 - aT8));
        aT8 <- 8;
        ...
        if ((4 <= lEN)) {
          ...
          (trace_a1088____a_ilen_read_upto8_at ++
          [(Assert,
           ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 4) <= 1088)))]);
          trace_a1088____a_ilen_read_upto8_at <-
          (trace_a1088____a_ilen_read_upto8_at ++
          [(Assert, (BArray1088.is_init b_buf (offset + dELTA) 4))]);
          w <- (zeroextu64 (BArray1088.get32d buf (offset + dELTA)));
          param_2 <- w;
          param_1 <- aT8;
          (result_0, tmp__trace) <@ __SHLQ (param_2, param_1);
          trace_a1088____a_ilen_read_upto8_at <-
        ...
        if (((aT8 < 8) /\ (2 <= lEN))) {
          ...
          (trace_a1088____a_ilen_read_upto8_at ++
          [(Assert,
           ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 2) <= 1088)))]);
          trace_a1088____a_ilen_read_upto8_at <-
          (trace_a1088____a_ilen_read_upto8_at ++
          [(Assert, (BArray1088.is_init b_buf (offset + dELTA) 2))]);
          t16 <- (zeroextu64 (BArray1088.get16d buf (offset + dELTA)));
          dELTA <- (dELTA + ((8 <= (2 + aT8)) ? (8 - aT8) : 2));
          lEN <- (lEN - ((8 <= (2 + aT8)) ? (8 - aT8) : 2));
          param_4 <- t16;
          param_3 <- aT8;
        ...
        if ((aT8 < 8)) {
          if ((1 <= lEN)) {
            ...
            (trace_a1088____a_ilen_read_upto8_at ++
            [(Assert,
             ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 1) <= 1088)))]);
            trace_a1088____a_ilen_read_upto8_at <-
            (trace_a1088____a_ilen_read_upto8_at ++
            [(Assert, (BArray1088.is_init b_buf (offset + dELTA) 1))]);
            t8 <- (zeroextu64 (BArray1088.get8d buf (offset + dELTA)));
            t8 <- (t8 `|` (W64.of_int (256 * (tRAIL %% 256))));
            dELTA <- (dELTA + 1);
            lEN <- (lEN - 1);
            param_6 <- t8;
    ...
    return (dELTA, lEN, tRAIL, aT, w, trace_a1088____a_ilen_read_upto8_at);
  }
  proc a1088____addstate_ref (st:BArray200.t, b_st:BArray200.t, aT:int,
                              buf:BArray1088.t, b_buf:BArray1088.t,
    ...
    var param_10:int;
    var param_11:int;
    var param_12:BArray1088.t;
    var result_4:W64.t;
    var result_5:int;
    var result_6:int;
    var result_7:int;
    var result_8:int;
    var b_param:BArray1088.t;
    var b_param_0:BArray1088.t;
    var trace_a1088____addstate_ref:trace;
    b_param <- witness;
    b_param_0 <- witness;
    param_5 <- witness;
    param_12 <- witness;
    trace_a1088____addstate_ref <- [];
    trace_a1088____addstate_ref <-
    (trace_a1088____addstate_ref ++
    [(Assert,
     (((0 <= _LEN) /\ (_LEN <= 18446744073709551615)) /\
     (((0 <= (offset + _LEN)) /\ ((offset + _LEN) <= 18446744073709551615)) /\
     (((((0 <= offset) /\ (0 <= _LEN)) /\ ((offset + _LEN) <= 1088)) /\
      (BArray1088.is_init b_buf offset _LEN)) /\
     (BArray200.is_init b_st 0 200)))))]);
    trace_a1088____addstate_ref <-
    (trace_a1088____addstate_ref ++
    [(Assert,
    ...
    if ((aT8 <> 0)) {
      ...
      param <- aT8;
      (result_3, result_2, result_1, result_0, result, tmp__trace) <@ 
      a1088____a_ilen_read_upto8_at (param_5, b_param_0, param_4, param_3,
      param_2, param_1, param_0, param);
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++ tmp__trace);
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++
      [(Assert,
       (((param_0 <= param) /\ (param < (param_0 + 8))) ? ((((result_3 =
    ...
    while ((at < ((aT %/ 8) + (_LEN %/ 8)))) {
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++
      [(Assert, ((0 <= offset) /\ ((offset + 8) <= 1088)))]);
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++
      [(Assert, (BArray1088.is_init b_buf offset 8))]);
      w <- (BArray1088.get64d buf offset);
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++
      [(Assert,
       ((0 <= (offset + 8)) /\ ((offset + 8) <= 18446744073709551615)))]);
    ...
    if (((0 < _LEN) \/ ((_TRAILB %% 256) <> 0))) {
      ...
      param_6 <- aT;
      (result_8, result_7, result_6, result_5, result_4, tmp__trace) <@ 
      a1088____a_ilen_read_upto8_at (param_12, b_param, param_11, param_10,
      param_9, param_8, param_7, param_6);
      trace_a1088____addstate_ref <-
      (trace_a1088____addstate_ref ++ tmp__trace);
      trace_a1088____addstate_ref <-
    ...
    b_st <- (BArray200.init_arr (W8.of_int 255));
    return (st, b_st, aT, offset, trace_a1088____addstate_ref);
  }
  proc a1088____absorb_ref (st:BArray200.t, b_st:BArray200.t, aT:int,
                            buf:BArray1088.t, b_buf:BArray1088.t,
    ...
    var b_result_4:BArray200.t;
    var b_param_0:BArray200.t;
    var trace_a1088____absorb_ref:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_result <- witness;
    b_result_0 <- witness;
    ...
    [(Assert,
     ((((((((0 < _RATE8) /\ (_RATE8 < 200)) /\ (0 <= _TRAILB)) /\
        ...
        (0 <= aT)) /\
       (aT < _RATE8)) /\
      (BArray1088.is_init b_buf 0 1088)) /\
     (BArray200.is_init b_st 0 224)))]);
    offset <- 0;
    _LEN <- 1088;
    if ((_RATE8 <= (aT + _LEN))) {
      ...
      param_0 <- (_RATE8 - aT);
      param <- 0;
      (aux, aux_0, aux_1, aux_2, tmp__trace) <@ a1088____addstate_ref (
      param_4, b_param_0, param_3, param_2,
      (BArray1088.init_arr (W8.of_int 255)), param_1, param_0, param);
      result_1 <- aux;
      b_result_4 <- aux_0;
      result_0 <- aux_1;
      result <- aux_2;
      trace_a1088____absorb_ref <- (trace_a1088____absorb_ref ++ tmp__trace);
      trace_a1088____absorb_ref <-
      (trace_a1088____absorb_ref ++
      [(Assert,
       (((0 <= param_0) /\ (param_0 <= 18446744073709551615)) /\
      ...
      while ((i < iTERS)) {
        ...
        (aux, aux_0, aux_1, aux_2, tmp__trace) <@ a1088____addstate_ref (
        param_11, (BArray200.init_arr (W8.of_int 255)), param_10, param_9,
        (BArray1088.init_arr (W8.of_int 255)), param_8, param_7, param_6);
        result_5 <- aux;
        b_result_2 <- aux_0;
        result_4 <- aux_1;
        result_3 <- aux_2;
        trace_a1088____absorb_ref <-
        (trace_a1088____absorb_ref ++ tmp__trace);
        trace_a1088____absorb_ref <-
        (trace_a1088____absorb_ref ++
        [(Assert,
         (((0 <= param_7) /\ (param_7 <= 18446744073709551615)) /\
    ...
    (BArray1088.init_arr (W8.of_int 255)), param_15, param_14, param_13);
    result_9 <- aux;
    b_result_0 <- aux_0;
    result_8 <- aux_1;
    result_7 <- aux_2;
    ...
    b_st <- (BArray200.init_arr (W8.of_int 255));
    return (st, b_st, aT, trace_a1088____absorb_ref);
  }
  proc a1184____a_ilen_read_upto8_at (buf:BArray1184.t, b_buf:BArray1184.t,
                                      offset:int, dELTA:int, lEN:int,
                                      tRAIL:int, cUR:int, aT:int) : int *
                                                                    int *
                                                                    int *
    ...
    var param_8:W64.t;
    var result_3:W64.t;
    var trace_a1184____a_ilen_read_upto8_at:trace;
    trace_a1184____a_ilen_read_upto8_at <- [];
    trace_a1184____a_ilen_read_upto8_at <-
    (trace_a1184____a_ilen_read_upto8_at ++
    [(Assert,
     (((0 <= dELTA) /\ (dELTA <= 18446744073709551615)) /\
     ...
     (((0 <= ((offset + dELTA) + ((lEN < 8) ? lEN : 8))) /\
      (((offset + dELTA) + ((lEN < 8) ? lEN : 8)) <= 18446744073709551615)) /\
     ((((((BArray1184.is_init b_buf (offset + dELTA) ((lEN < 8) ? lEN : 8)) /\
         (0 <= dELTA)) /\
        (0 <= offset)) /\
       (((offset + dELTA) + ((lEN < 8) ? lEN : 8)) <= 1184)) /\
      (0 <= tRAIL)) /\
     (tRAIL < 256)))))))))]);
    trace_a1184____a_ilen_read_upto8_at <-
    (trace_a1184____a_ilen_read_upto8_at ++
    ...
    if ((((aT < cUR) \/ ((cUR + 8) <= aT)) \/ ((lEN = 0) /\ (tRAIL = 0)))) {
      ...
      if ((8 <= lEN)) {
        ...
        (trace_a1184____a_ilen_read_upto8_at ++
        [(Assert,
         ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 8) <= 1184)))]);
        trace_a1184____a_ilen_read_upto8_at <-
        (trace_a1184____a_ilen_read_upto8_at ++
        [(Assert, (BArray1184.is_init b_buf (offset + dELTA) 8))]);
        w <- (BArray1184.get64d buf (offset + dELTA));
        param_0 <- w;
        param <- aT8;
        (result, tmp__trace) <@ __SHLQ (param_0, param);
        trace_a1184____a_ilen_read_upto8_at <-
        (trace_a1184____a_ilen_read_upto8_at ++ tmp__trace);
        w <- result;
        dELTA <- (dELTA + (8 - aT8));
        lEN <- (lEN - (8 - aT8));
        aT8 <- 8;
        ...
        if ((4 <= lEN)) {
          ...
          (trace_a1184____a_ilen_read_upto8_at ++
          [(Assert,
           ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 4) <= 1184)))]);
          trace_a1184____a_ilen_read_upto8_at <-
          (trace_a1184____a_ilen_read_upto8_at ++
          [(Assert, (BArray1184.is_init b_buf (offset + dELTA) 4))]);
          w <- (zeroextu64 (BArray1184.get32d buf (offset + dELTA)));
          param_2 <- w;
          param_1 <- aT8;
          (result_0, tmp__trace) <@ __SHLQ (param_2, param_1);
          trace_a1184____a_ilen_read_upto8_at <-
        ...
        if (((aT8 < 8) /\ (2 <= lEN))) {
          ...
          (trace_a1184____a_ilen_read_upto8_at ++
          [(Assert,
           ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 2) <= 1184)))]);
          trace_a1184____a_ilen_read_upto8_at <-
          (trace_a1184____a_ilen_read_upto8_at ++
          [(Assert, (BArray1184.is_init b_buf (offset + dELTA) 2))]);
          t16 <- (zeroextu64 (BArray1184.get16d buf (offset + dELTA)));
          dELTA <- (dELTA + ((8 <= (2 + aT8)) ? (8 - aT8) : 2));
          lEN <- (lEN - ((8 <= (2 + aT8)) ? (8 - aT8) : 2));
          param_4 <- t16;
          param_3 <- aT8;
        ...
        if ((aT8 < 8)) {
          if ((1 <= lEN)) {
            ...
            (trace_a1184____a_ilen_read_upto8_at ++
            [(Assert,
             ((0 <= (offset + dELTA)) /\ (((offset + dELTA) + 1) <= 1184)))]);
            trace_a1184____a_ilen_read_upto8_at <-
            (trace_a1184____a_ilen_read_upto8_at ++
            [(Assert, (BArray1184.is_init b_buf (offset + dELTA) 1))]);
            t8 <- (zeroextu64 (BArray1184.get8d buf (offset + dELTA)));
            t8 <- (t8 `|` (W64.of_int (256 * (tRAIL %% 256))));
            dELTA <- (dELTA + 1);
            lEN <- (lEN - 1);
            param_6 <- t8;
    ...
    return (dELTA, lEN, tRAIL, aT, w, trace_a1184____a_ilen_read_upto8_at);
  }
  proc a1184____addstate_ref (st:BArray200.t, b_st:BArray200.t, aT:int,
                              buf:BArray1184.t, b_buf:BArray1184.t,
                              offset:int, _LEN:int, _TRAILB:int) : BArray200.t *
                                                                   BArray200.t *
                                                                   int *
                                                                   int *
    ...
    var param_10:int;
    var param_11:int;
    var param_12:BArray1184.t;
    var result_4:W64.t;
    var result_5:int;
    var result_6:int;
    var result_7:int;
    var result_8:int;
    var b_param:BArray1184.t;
    var b_param_0:BArray1184.t;
    var trace_a1184____addstate_ref:trace;
    b_param <- witness;
    b_param_0 <- witness;
    param_5 <- witness;
    param_12 <- witness;
    trace_a1184____addstate_ref <- [];
    trace_a1184____addstate_ref <-
    (trace_a1184____addstate_ref ++
    [(Assert,
     (((0 <= _LEN) /\ (_LEN <= 18446744073709551615)) /\
     (((0 <= (offset + _LEN)) /\ ((offset + _LEN) <= 18446744073709551615)) /\
     (((((0 <= offset) /\ (0 <= _LEN)) /\ ((offset + _LEN) <= 1184)) /\
      (BArray1184.is_init b_buf offset _LEN)) /\
     (BArray200.is_init b_st 0 200)))))]);
    trace_a1184____addstate_ref <-
    (trace_a1184____addstate_ref ++
    [(Assert,
    ...
    if ((aT8 <> 0)) {
      ...
      param <- aT8;
      (result_3, result_2, result_1, result_0, result, tmp__trace) <@ 
      a1184____a_ilen_read_upto8_at (param_5, b_param_0, param_4, param_3,
      param_2, param_1, param_0, param);
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++ tmp__trace);
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++
      [(Assert,
       (((param_0 <= param) /\ (param < (param_0 + 8))) ? ((((result_3 =
    ...
    while ((at < ((aT %/ 8) + (_LEN %/ 8)))) {
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++
      [(Assert, ((0 <= offset) /\ ((offset + 8) <= 1184)))]);
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++
      [(Assert, (BArray1184.is_init b_buf offset 8))]);
      w <- (BArray1184.get64d buf offset);
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++
      [(Assert,
       ((0 <= (offset + 8)) /\ ((offset + 8) <= 18446744073709551615)))]);
    ...
    if (((0 < _LEN) \/ ((_TRAILB %% 256) <> 0))) {
      ...
      param_6 <- aT;
      (result_8, result_7, result_6, result_5, result_4, tmp__trace) <@ 
      a1184____a_ilen_read_upto8_at (param_12, b_param, param_11, param_10,
      param_9, param_8, param_7, param_6);
      trace_a1184____addstate_ref <-
      (trace_a1184____addstate_ref ++ tmp__trace);
      trace_a1184____addstate_ref <-
    ...
    b_st <- (BArray200.init_arr (W8.of_int 255));
    return (st, b_st, aT, offset, trace_a1184____addstate_ref);
  }
  proc a1184____absorb_ref (st:BArray200.t, b_st:BArray200.t, aT:int,
                            buf:BArray1184.t, b_buf:BArray1184.t,
                            _TRAILB:int, _RATE8:int) : BArray200.t *
                                                       BArray200.t * int *
                                                       trace = {
    ...
    var b_result_4:BArray200.t;
    var b_param_0:BArray200.t;
    var trace_a1184____absorb_ref:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_result <- witness;
    b_result_0 <- witness;
    ...
    [(Assert,
     ((((((((0 < _RATE8) /\ (_RATE8 < 200)) /\ (0 <= _TRAILB)) /\
        ...
        (0 <= aT)) /\
       (aT < _RATE8)) /\
      (BArray1184.is_init b_buf 0 1184)) /\
     (BArray200.is_init b_st 0 224)))]);
    offset <- 0;
    _LEN <- 1184;
    if ((_RATE8 <= (aT + _LEN))) {
      ...
      param_0 <- (_RATE8 - aT);
      param <- 0;
      (aux, aux_0, aux_1, aux_2, tmp__trace) <@ a1184____addstate_ref (
      param_4, b_param_0, param_3, param_2,
      (BArray1184.init_arr (W8.of_int 255)), param_1, param_0, param);
      result_1 <- aux;
      b_result_4 <- aux_0;
      result_0 <- aux_1;
      result <- aux_2;
      trace_a1184____absorb_ref <- (trace_a1184____absorb_ref ++ tmp__trace);
      trace_a1184____absorb_ref <-
      (trace_a1184____absorb_ref ++
      [(Assert,
       (((0 <= param_0) /\ (param_0 <= 18446744073709551615)) /\
      ...
      while ((i < iTERS)) {
        ...
        (aux, aux_0, aux_1, aux_2, tmp__trace) <@ a1184____addstate_ref (
        param_11, (BArray200.init_arr (W8.of_int 255)), param_10, param_9,
        (BArray1184.init_arr (W8.of_int 255)), param_8, param_7, param_6);
        result_5 <- aux;
        b_result_2 <- aux_0;
        result_4 <- aux_1;
        result_3 <- aux_2;
        trace_a1184____absorb_ref <-
        (trace_a1184____absorb_ref ++ tmp__trace);
        trace_a1184____absorb_ref <-
        (trace_a1184____absorb_ref ++
        [(Assert,
         (((0 <= param_7) /\ (param_7 <= 18446744073709551615)) /\
    ...
    (aux, aux_0, aux_1, aux_2, tmp__trace) <@ a1184____addstate_ref (
    param_18, b_param, param_17, param_16,
    (BArray1184.init_arr (W8.of_int 255)), param_15, param_14, param_13);
    result_9 <- aux;
    b_result_0 <- aux_0;
    result_8 <- aux_1;
    result_7 <- aux_2;
    ...
    b_st <- (BArray200.init_arr (W8.of_int 255));
    return (st, b_st, aT, trace_a1184____absorb_ref);
  }
  ...
  proc _shake256_A32__A1120 (out:BArray32.t, b_out:BArray32.t,
                             in0:BArray32.t, b_in0:BArray32.t,
                             in1:BArray1088.t, b_in1:BArray1088.t) : 
  BArray32.t * BArray32.t * trace = {
    ...
    var b_param_2:BArray200.t;
    var b_st_s:BArray200.t;
    var trace__shake256_A32__A1120:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_param_1 <- witness;
    b_param_2 <- witness;
    ...
    st <- witness;
    st_s <- witness;
    trace__shake256_A32__A1120 <- [];
    trace__shake256_A32__A1120 <-
    (trace__shake256_A32__A1120 ++
    [(Assert,
     ((BArray32.is_init b_in0 0 32) /\ (BArray1088.is_init b_in1 0 1088)))]);
    b_st_s <- (BArray200.init_arr (W8.of_int 0));
    b_st <- b_st_s;
    st <- st_s;
    b_param_2 <- b_st;
    ...
    result <- aux;
    b_result_3 <- aux_0;
    trace__shake256_A32__A1120 <- (trace__shake256_A32__A1120 ++ tmp__trace);
    trace__shake256_A32__A1120 <-
    (trace__shake256_A32__A1120 ++
    [(Assert, (BArray200.is_init b_result_3 0 200))]);
    st <- result;
    ...
    param_6 <- 31;
    param_5 <- 136;
    (aux, aux_0, aux_1, tmp__trace) <@ a1088____absorb_ref (param_9,
    b_param_1, param_8, param_7, (BArray1088.init_arr (W8.of_int 255)),
    param_6, param_5);
    result_3 <- aux;
    b_result_1 <- aux_0;
    result_2 <- aux_1;
    ...
    return (out, b_out, trace__shake256_A32__A1120);
  }
  ...
  proc _sha3_256A_A1184 (out:BArray32.t, b_out:BArray32.t, in_0:BArray1184.t,
                         b_in:BArray1184.t) : BArray32.t * BArray32.t * trace = {
    var aux:BArray200.t;
    var aux_0:BArray200.t;
    var aux_2:BArray32.t;
    var aux_3:BArray32.t;
    ...
    var b_param_1:BArray200.t;
    var b_st_s:BArray200.t;
    var trace__sha3_256A_A1184:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_param_1 <- witness;
    b_result <- witness;
    ...
    st <- witness;
    st_s <- witness;
    trace__sha3_256A_A1184 <- [];
    trace__sha3_256A_A1184 <-
    (trace__sha3_256A_A1184 ++ [(Assert, (BArray1184.is_init b_in 0 1184))]);
    b_st_s <- (BArray200.init_arr (W8.of_int 0));
    (* Erased call to spill *)
    b_st <- b_st_s;
    st <- st_s;
    ...
    result <- aux;
    b_result_2 <- aux_0;
    trace__sha3_256A_A1184 <- (trace__sha3_256A_A1184 ++ tmp__trace);
    trace__sha3_256A_A1184 <-
    (trace__sha3_256A_A1184 ++
    [(Assert, (BArray200.is_init b_result_2 0 200))]);
    st <- result;
    ...
    param_1 <- 6;
    param_0 <- 136;
    (aux, aux_0, aux_1, tmp__trace) <@ a1184____absorb_ref (param_4,
    (BArray200.init_arr (W8.of_int 255)), param_3, param_2,
    (BArray1184.init_arr (W8.of_int 255)), param_1, param_0);
    result_1 <- aux;
    b_result_1 <- aux_0;
    result_0 <- aux_1;
    trace__sha3_256A_A1184 <- (trace__sha3_256A_A1184 ++ tmp__trace);
    ...
    [(Assert, (BArray200.is_init b_result_0 0 224))]);
    trace__sha3_256A_A1184 <-
    (trace__sha3_256A_A1184 ++ [(Assert, (BArray32.is_init b_result 0 32))]);
    out <- result_2;
    b_out <- (BArray32.init_arr (W8.of_int 255));
    return (out, b_out, trace__sha3_256A_A1184);
  }
  ...
  proc _i_poly_compress (rp:BArray128.t, b_rp:BArray128.t, a:BArray512.t,
    ...
    while ((i < 128)) {
      ...
      (trace__i_poly_compress ++
      [(Assert, ((0 <= ((2 * i) * 2)) /\ ((((2 * i) * 2) + 2) <= 512)))]);
      d0 <- (zeroextu32 (BArray512.get16 a (2 * i)));
      trace__i_poly_compress <-
      (trace__i_poly_compress ++
      [(Assert, ((0 <= (2 * i)) /\ ((2 * i) <= 18446744073709551615)))]);
      trace__i_poly_compress <-
      ...
      [(Assert,
       ((0 <= (((2 * i) + 1) * 2)) /\ (((((2 * i) + 1) * 2) + 2) <= 512)))]);
      d1 <- (zeroextu32 (BArray512.get16 a ((2 * i) + 1)));
      d0 <- (d0 `<<` (W8.of_int 4));
      ...
      d0 <- (d0 `|` d1);
      trace__i_poly_compress <-
      (trace__i_poly_compress ++ [(Assert, ((0 <= i) /\ ((i + 1) <= 128)))]);
      b_rp <- (BArray128.set8d b_rp i (W8.of_int 255));
      rp <- (BArray128.set8 rp i (truncateu8 d0));
      trace__i_poly_compress <-
      (trace__i_poly_compress ++
      [(Assert, ((0 <= (i + 1)) /\ ((i + 1) <= 18446744073709551615)))]);
      i <- (i + 1);
  ...
  proc _i_poly_decompress (rp:BArray512.t, b_rp:BArray512.t, ap:BArray128.t,
                           b_ap:BArray128.t) : BArray512.t * BArray512.t *
                                               trace = {
    var t:W8.t;
    var d0:W16.t;
    var d1:W16.t;
    ...
    trace__i_poly_decompress <-
    (trace__i_poly_decompress ++ [(Assert, (BArray128.is_init b_ap 0 128))]);
    i <- 0;
    while ((i < 128)) {
      trace__i_poly_decompress <-
      (trace__i_poly_decompress ++
      [(Assert, ((0 <= i) /\ ((i + 1) <= 128)))]);
      t <- (BArray128.get8 ap i);
      d0 <- (zeroextu16 t);
      d1 <- (zeroextu16 t);
      d0 <- (d0 `&` (W16.of_int 15));
      d1 <- (d1 `>>` (W8.of_int 4));
  ...
  proc __polyvec_add2 (r:BArray1536.t, b_r:BArray1536.t, b:BArray1536.t,
    ...
    trace___polyvec_add2 <-
    (trace___polyvec_add2 ++ [(Assert, (BArray1536.is_init b_r 0 1536))]);
    trace___polyvec_add2 <-
    (trace___polyvec_add2 ++ [(Assert, (BArray1536.is_init b_b 0 1536))]);
    i <- 0;
    while ((i < 3)) {
      trace___polyvec_add2 <-
      (trace___polyvec_add2 ++
    ...
    b_r <- (BArray1536.init_arr (W8.of_int 255));
  ...
  proc __polyvec_csubq (r:BArray1536.t, b_r:BArray1536.t) : BArray1536.t *
    ...
    trace___polyvec_csubq <-
    (trace___polyvec_csubq ++ [(Assert, (BArray1536.is_init b_r 0 1536))]);
    i <- 0;
    while ((i < 3)) {
      trace___polyvec_csubq <-
      (trace___polyvec_csubq ++
  ...
  proc __i_polyvec_frombytes (ap:BArray1152.t, b_ap:BArray1152.t) : BArray1536.t *
                                                                    BArray1536.t *
                                                                    trace = {
    var aux:BArray512.t;
    var aux_0:BArray512.t;
    ...
    trace___i_polyvec_frombytes <-
    (trace___i_polyvec_frombytes ++
    [(Assert, (BArray1152.is_init b_ap 0 1152))]);
    b_r <- (BArray1536.init_arr (W8.of_int 0));
    i <- 0;
    while ((i < 3)) {
      trace___i_polyvec_frombytes <-
      (trace___i_polyvec_frombytes ++
      ...
      trace___i_polyvec_frombytes <-
      (trace___i_polyvec_frombytes ++
      [(Assert, ((0 <= (384 * i)) /\ (((384 * i) + 384) <= 1152)))]);
      b_param_0 <- (SBArray1536_512.get_sub16 b_r (256 * i));
      param_0 <- (SBArray1536_512.get_sub16 r (256 * i));
      b_param <- (SBArray1152_384.get_sub8 b_ap (384 * i));
      param <- (SBArray1152_384.get_sub8 ap (384 * i));
  ...
  proc __polyvec_invntt (r:BArray1536.t, b_r:BArray1536.t) : BArray1536.t *
    ...
    trace___polyvec_invntt <-
    (trace___polyvec_invntt ++ [(Assert, (BArray1536.is_init b_r 0 1536))]);
    i <- 0;
    while ((i < 3)) {
      trace___polyvec_invntt <-
      (trace___polyvec_invntt ++
  ...
  proc __polyvec_ntt (r:BArray1536.t, b_r:BArray1536.t) : BArray1536.t *
    ...
    trace___polyvec_ntt <- [];
    trace___polyvec_ntt <-
    (trace___polyvec_ntt ++ [(Assert, (BArray1536.is_init b_r 0 1536))]);
    i <- 0;
    while ((i < 3)) {
      trace___polyvec_ntt <-
      (trace___polyvec_ntt ++
  ...
  proc __polyvec_pointwise_acc (a:BArray1536.t, b_a:BArray1536.t,
    ...
    while ((i < 3)) {
      ...
      param_3 <- (SBArray1536_512.get_sub16 a (256 * i));
      b_param <- (SBArray1536_512.get_sub16 b_b (256 * i));
      param_2 <- (SBArray1536_512.get_sub16 b (256 * i));
  ...
  proc __polyvec_reduce (r:BArray1536.t, b_r:BArray1536.t) : BArray1536.t *
    ...
    trace___polyvec_reduce <-
    (trace___polyvec_reduce ++ [(Assert, (BArray1536.is_init b_r 0 1536))]);
    i <- 0;
    while ((i < 3)) {
      trace___polyvec_reduce <-
      (trace___polyvec_reduce ++
  ...
  proc __i_polyvec_tobytes (rp:BArray1152.t, b_rp:BArray1152.t,
                            a:BArray1536.t, b_a:BArray1536.t) : BArray1152.t *
                                                                BArray1152.t *
                                                                trace = {
    var aux:BArray384.t;
    ...
    while ((i < 3)) {
      ...
      [(Assert,
       ((0 <= ((256 * i) * 2)) /\ ((((256 * i) * 2) + 512) <= 1536)))]);
      b_param_0 <- (SBArray1152_384.get_sub8 b_rp (384 * i));
      param_0 <- (SBArray1152_384.get_sub8 rp (384 * i));
      ...
      b_rp <-
      (SBArray1152_384.set_sub8 b_rp (384 * i)
      (BArray384.init_arr (W8.of_int 255)));
      rp <- (SBArray1152_384.set_sub8 rp (384 * i) result_0);
      i <- (i + 1);
    }
    return (rp, b_rp, trace___i_polyvec_tobytes);
  }
  proc __i_polyvec_compress (rp:BArray960.t, b_rp:BArray960.t,
                             a:BArray1536.t, b_a:BArray1536.t) : BArray960.t *
                                                                 BArray960.t *
                                                                 trace = {
    var aux:BArray1536.t;
    var aux_0:BArray1536.t;
    var aa:BArray1536.t;
    var k:int;
    var t:BArray32.t;
    var c:W16.t;
    ...
    (trace___i_polyvec_compress ++
    [(Assert, (BArray1536.is_init b_a 0 1536))]);
    b_t <- (BArray32.init_arr (W8.of_int 0));
    i <- 0;
    j <- 0;
    param <- a;
    ...
    while ((i < 765)) {
      ...
      while ((k < 4)) {
        ...
        trace___i_polyvec_compress <-
        (trace___i_polyvec_compress ++
        [(Assert, ((0 <= (k * 8)) /\ (((k * 8) + 8) <= 32)))]);
        trace___i_polyvec_compress <-
        (trace___i_polyvec_compress ++
        [(Assert, ((0 <= ((i + k) * 2)) /\ ((((i + k) * 2) + 2) <= 1536)))]);
        b_t <-
        (BArray32.set64d b_t (k * 8) (W64.of_int 18446744073709551615));
        t <- (BArray32.set64 t k (zeroextu64 (BArray1536.get16 aa (i + k))));
        trace___i_polyvec_compress <-
        (trace___i_polyvec_compress ++
        [(Assert, ((0 <= (k * 8)) /\ (((k * 8) + 8) <= 32)))]);
        trace___i_polyvec_compress <-
        ...
        trace___i_polyvec_compress <-
        (trace___i_polyvec_compress ++
        [(Assert, (BArray32.is_init b_t (k * 8) 8))]);
        b_t <-
        (BArray32.set64d b_t (k * 8) (W64.of_int 18446744073709551615));
      ...
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 0 8))]);
      c <- (truncateu16 (BArray32.get64 t 0));
      c <- (c `&` (W16.of_int 255));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++
      [(Assert, ((0 <= j) /\ ((j + 1) <= 960)))]);
      b_rp <- (BArray960.set8d b_rp j (W8.of_int 255));
      rp <- (BArray960.set8 rp j (truncateu8 c));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++
      [(Assert, ((0 <= (j + 1)) /\ ((j + 1) <= 18446744073709551615)))]);
      j <- (j + 1);
      ...
      b <- (b `>>` (W8.of_int 8));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 8 8))]);
      ...
      b <- (b `>>` (W8.of_int 6));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 16 8))]);
      ...
      b <- (b `>>` (W8.of_int 4));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 24 8))]);
      ...
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 24 8))]);
      b_t <- (BArray32.set64d b_t 24 (W64.of_int 18446744073709551615));
      ...
      (trace___i_polyvec_compress ++ [(Assert, (BArray32.is_init b_t 24 8))]);
      b_rp <- (BArray960.set8d b_rp j (W8.of_int 255));
      rp <- (BArray960.set8 rp j (truncateu8 (BArray32.get64 t 3)));
      trace___i_polyvec_compress <-
      (trace___i_polyvec_compress ++
      [(Assert, ((0 <= (j + 1)) /\ ((j + 1) <= 18446744073709551615)))]);
      j <- (j + 1);
  ...
  proc __i_polyvec_decompress (rp:BArray1536.t, b_rp:BArray1536.t,
                               ap:BArray960.t, b_ap:BArray960.t) : BArray1536.t *
                                                                   BArray1536.t *
                                                                   trace = {
    var k:int;
    var t:BArray20.t;
    ...
    trace___i_polyvec_decompress <-
    (trace___i_polyvec_decompress ++
    [(Assert, (BArray960.is_init b_ap 0 960))]);
    b_t <- (BArray20.init_arr (W8.of_int 0));
    i <- 0;
    j <- 0;
    while ((i < 765)) {
      k <- 0;
      while ((k < 5)) {
        trace___i_polyvec_decompress <-
        (trace___i_polyvec_decompress ++
        [(Assert, ((0 <= (k * 4)) /\ (((k * 4) + 4) <= 20)))]);
        trace___i_polyvec_decompress <-
        (trace___i_polyvec_decompress ++
        [(Assert, ((0 <= j) /\ ((j + 1) <= 960)))]);
        b_t <- (BArray20.set32d b_t (k * 4) (W32.of_int 4294967295));
        t <- (BArray20.set32 t k (zeroextu32 (BArray960.get8 ap j)));
        trace___i_polyvec_decompress <-
        (trace___i_polyvec_decompress ++
        [(Assert, ((0 <= (j + 1)) /\ ((j + 1) <= 18446744073709551615)))]);
        j <- (j + 1);
      ...
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 4 4))]);
      d <- (BArray20.get32 t 1);
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 4 4))]);
      b_t <- (BArray20.set32d b_t 4 (W32.of_int 4294967295));
      t <- (BArray20.set32 t 1 ((BArray20.get32 t 1) `>>` (W8.of_int 2)));
      d <- (d `&` (W32.of_int 3));
      d <- (d `<<` (W8.of_int 8));
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 0 4))]);
      b_t <- (BArray20.set32d b_t 0 (W32.of_int 4294967295));
      t <- (BArray20.set32 t 0 ((BArray20.get32 t 0) `|` d));
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 8 4))]);
      d <- (BArray20.get32 t 2);
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 8 4))]);
      b_t <- (BArray20.set32d b_t 8 (W32.of_int 4294967295));
      ...
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 12 4))]);
      d <- (BArray20.get32 t 3);
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 12 4))]);
      b_t <- (BArray20.set32d b_t 12 (W32.of_int 4294967295));
      ...
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
      [(Assert, (BArray20.is_init b_t 16 4))]);
      ...
      while ((k < 4)) {
        ...
        trace___i_polyvec_decompress <-
        (trace___i_polyvec_decompress ++
        [(Assert, (BArray20.is_init b_t (k * 4) 4))]);
        b_t <- (BArray20.set32d b_t (k * 4) (W32.of_int 4294967295));
        ...
        (trace___i_polyvec_decompress ++
        [(Assert, (BArray20.is_init b_t (k * 4) 4))]);
        b_rp <- (BArray1536.set16d b_rp ((i + k) * 2) (W16.of_int 65535));
        rp <-
        (BArray1536.set16 rp (i + k) (truncateu16 (BArray20.get32 t k)));
        k <- (k + 1);
      }
      trace___i_polyvec_decompress <-
      (trace___i_polyvec_decompress ++
  ...
  BArray4608.t * BArray4608.t * trace = {
    ...
    b_r <- (BArray4608.init_arr (W8.of_int 0));
    ...
    while ((i < 3)) {
      ...
      while ((j < 3)) {
        ...
        [(Assert,
         ((0 <= (((i * 768) + (j * 256)) * 2)) /\
         (((((i * 768) + (j * 256)) * 2) + 512) <= 4608)))]);
        b_rij <- (SBArray4608_512.get_sub16 b_r ((i * 768) + (j * 256)));
        rij <- (SBArray4608_512.get_sub16 r ((i * 768) + (j * 256)));
        ...
        [(Assert,
         ((0 <= (((i * 768) + (j * 256)) * 2)) /\
         (((((i * 768) + (j * 256)) * 2) + 512) <= 4608)))]);
        b_r <- (SBArray4608_512.set_sub16 b_r ((i * 768) + (j * 256)) b_rij);
        r <- (SBArray4608_512.set_sub16 r ((i * 768) + (j * 256)) rij);
        j <- (j + 1);
      }
      i <- (i + 1);
    }
  ...
  proc __indcpa_keypair (pk:BArray1184.t, b_pk:BArray1184.t, sk:BArray1152.t,
                         b_sk:BArray1152.t, randomnessp:BArray32.t,
                         b_randomnessp:BArray32.t) : BArray1184.t *
                                                     BArray1184.t *
                                                     BArray1152.t *
                                                     BArray1152.t * trace = {
    var aux_3:BArray1536.t;
    var aux_4:BArray1536.t;
    var aux:BArray4608.t;
    var aux_0:BArray4608.t;
    var aux_1:BArray512.t;
    var aux_2:BArray512.t;
    var i:int;
    var t64:W64.t;
    ...
    var result_2:BArray512.t;
    var param_9:BArray1536.t;
    var result_3:BArray1536.t;
    var param_10:BArray1536.t;
    var result_4:BArray1536.t;
    var param_11:BArray1536.t;
    var param_12:BArray1536.t;
    var result_5:BArray512.t;
    var param_13:BArray512.t;
    var result_6:BArray512.t;
    var param_14:BArray1536.t;
    var param_15:BArray1536.t;
    var result_7:BArray1536.t;
    var param_16:BArray1536.t;
    var result_8:BArray1536.t;
    var param_17:BArray1536.t;
    var param_18:BArray1152.t;
    var result_9:BArray1152.t;
    var param_19:BArray1536.t;
    var param_20:BArray1152.t;
    var result_10:BArray1152.t;
    var b_publicseed:BArray32.t;
    var b_result:BArray1152.t;
    var b_param:BArray1152.t;
    var b_pkpv:BArray1536.t;
    var b_result_0:BArray1152.t;
    var b_param_0:BArray1152.t;
    var b_skpv:BArray1536.t;
    var b_result_1:BArray1536.t;
    var b_result_2:BArray1536.t;
    var b_param_1:BArray1536.t;
    var b_e:BArray1536.t;
    var b_result_3:BArray512.t;
    var b_param_2:BArray512.t;
    var b_result_4:BArray512.t;
    var b_param_3:BArray1536.t;
    var b_aa:BArray4608.t;
    var b_result_5:BArray1536.t;
    var b_param_4:BArray1536.t;
    var b_result_6:BArray1536.t;
    var b_param_5:BArray1536.t;
    ...
    b_skpv <- (BArray1536.init_arr (W8.of_int 0));
    b_e <- (BArray1536.init_arr (W8.of_int 0));
    b_pkpv <- (BArray1536.init_arr (W8.of_int 0));
    (* Erased call to spill *)
    i <- 0;
    while ((i < 4)) {
      trace___indcpa_keypair <-
    ...
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray4608.is_init b_result_9 0 4608))]);
    b_aa <- (BArray4608.init_arr (W8.of_int 255));
    aa <- result_0;
    i <- 0;
    while ((i < 3)) {
      nonce <- (W8.of_int i);
      ...
      (trace___indcpa_keypair ++
      [(Assert,
       ((0 <= ((i * 256) * 2)) /\ ((((i * 256) * 2) + 512) <= 1536)))]);
      trace___indcpa_keypair <-
      (trace___indcpa_keypair ++
      [(Assert,
       ((0 <= ((i * 256) * 2)) /\ ((((i * 256) * 2) + 512) <= 1536)))]);
      b_param_9 <- (SBArray1536_512.get_sub16 b_skpv (i * 256));
      param_5 <- (SBArray1536_512.get_sub16 skpv (i * 256));
      ...
      b_skpv <-
      (SBArray1536_512.set_sub16 b_skpv (i * 256)
      (BArray512.init_arr (W8.of_int 255)));
      skpv <- (SBArray1536_512.set_sub16 skpv (i * 256) result_1);
      i <- (i + 1);
    }
    i <- 0;
    while ((i < 3)) {
      ...
      [(Assert,
       ((0 <= ((i * 256) * 2)) /\ ((((i * 256) * 2) + 512) <= 1536)))]);
      b_param_7 <- (SBArray1536_512.get_sub16 b_e (i * 256));
      param_8 <- (SBArray1536_512.get_sub16 e (i * 256));
      ...
      b_e <-
      (SBArray1536_512.set_sub16 b_e (i * 256)
      (BArray512.init_arr (W8.of_int 255)));
      e <- (SBArray1536_512.set_sub16 e (i * 256) result_2);
      i <- (i + 1);
    }
    b_param_5 <- b_skpv;
    param_9 <- skpv;
    ...
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray1536.is_init b_result_6 0 1536))]);
    skpv <- result_3;
    b_param_4 <- b_e;
    param_10 <- e;
    ...
    while ((i < 3)) {
      ...
      (trace___indcpa_keypair ++
      [(Assert,
       ((0 <= ((i * 768) * 2)) /\ ((((i * 768) * 2) + 1536) <= 4608)))]);
      b_param_3 <- (SBArray4608_1536.get_sub16 b_aa (i * 768));
      param_12 <- (SBArray4608_1536.get_sub16 aa (i * 768));
      param_11 <- skpv;
      (aux_1, aux_2, tmp__trace) <@ __polyvec_pointwise_acc (param_12,
      b_param_3, param_11, (BArray1536.init_arr (W8.of_int 255)));
      result_5 <- aux_1;
      b_result_4 <- aux_2;
      trace___indcpa_keypair <- (trace___indcpa_keypair ++ tmp__trace);
      trace___indcpa_keypair <-
      ...
      b_pkpv <-
      (SBArray1536_512.set_sub16 b_pkpv (i * 256)
      (BArray512.init_arr (W8.of_int 255)));
      pkpv <- (SBArray1536_512.set_sub16 pkpv (i * 256) result_5);
      trace___indcpa_keypair <-
      (trace___indcpa_keypair ++
      [(Assert,
       ((0 <= ((i * 256) * 2)) /\ ((((i * 256) * 2) + 512) <= 1536)))]);
      ...
      [(Assert,
       ((0 <= ((i * 256) * 2)) /\ ((((i * 256) * 2) + 512) <= 1536)))]);
      b_param_2 <- (SBArray1536_512.get_sub16 b_pkpv (i * 256));
      param_13 <- (SBArray1536_512.get_sub16 pkpv (i * 256));
      ...
      (SBArray1536_512.set_sub16 b_pkpv (i * 256)
      (BArray512.init_arr (W8.of_int 255)));
      pkpv <- (SBArray1536_512.set_sub16 pkpv (i * 256) result_6);
      i <- (i + 1);
    }
    b_param_1 <- b_pkpv;
    param_15 <- pkpv;
    ...
    param_14, (BArray1536.init_arr (W8.of_int 255)));
    result_7 <- aux_3;
    b_result_2 <- aux_4;
    trace___indcpa_keypair <- (trace___indcpa_keypair ++ tmp__trace);
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray1536.is_init b_result_2 0 1536))]);
    pkpv <- result_7;
    param_16 <- pkpv;
    ...
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray1536.is_init b_result_1 0 1536))]);
    pkpv <- result_8;
    (* Erased call to unspill *)
    b_param_0 <- b_sk;
    param_18 <- sk;
    ...
    b_param_0, param_17, (BArray1536.init_arr (W8.of_int 255)));
    trace___indcpa_keypair <- (trace___indcpa_keypair ++ tmp__trace);
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray1152.is_init b_result_0 0 1152))]);
    sk <- result_9;
    b_param <- (SBArray1184_1152.get_sub8 b_pk 0);
    param_20 <- (SBArray1184_1152.get_sub8 pk 0);
    param_19 <- pkpv;
    (result_10, b_result, tmp__trace) <@ __i_polyvec_tobytes (param_20,
    b_param, param_19, (BArray1536.init_arr (W8.of_int 255)));
    trace___indcpa_keypair <- (trace___indcpa_keypair ++ tmp__trace);
    trace___indcpa_keypair <-
    (trace___indcpa_keypair ++
    [(Assert, (BArray1152.is_init b_result 0 1152))]);
    b_pk <-
    (SBArray1184_1152.set_sub8 b_pk 0 (BArray1152.init_arr (W8.of_int 255)));
    pk <- (SBArray1184_1152.set_sub8 pk 0 result_10);
    i <- 0;
    while ((i < 4)) {
      trace___indcpa_keypair <-
      (trace___indcpa_keypair ++
      ...
      trace___indcpa_keypair <-
      (trace___indcpa_keypair ++
      [(Assert, ((0 <= ((i + 144) * 8)) /\ ((((i + 144) * 8) + 8) <= 1184)))]);
      b_pk <-
      (BArray1184.set64d b_pk ((i + 144) * 8)
      (W64.of_int 18446744073709551615));
      pk <- (BArray1184.set64d pk ((i + 144) * 8) t64);
      i <- (i + 1);
    }
    b_sk <- (BArray1152.init_arr (W8.of_int 255));
    return (pk, b_pk, sk, b_sk, trace___indcpa_keypair);
  }
  proc __indcpa_enc (ct:BArray1088.t, b_ct:BArray1088.t, msgp:BArray32.t,
                     b_msgp:BArray32.t, pk:BArray1184.t, b_pk:BArray1184.t,
                     noiseseed:BArray32.t, b_noiseseed:BArray32.t) : 
  BArray1088.t * BArray1088.t * trace = {
    var aux_5:BArray128.t;
    var aux_6:BArray128.t;
    var aux:BArray1536.t;
    var aux_0:BArray1536.t;
    var aux_3:BArray4608.t;
    var aux_4:BArray4608.t;
    var aux_1:BArray512.t;
    var aux_2:BArray512.t;
    var s_ct:BArray1088.t;
    var pkpv:BArray1536.t;
    var w:int;
    var t64:W64.t;
    var publicseed:BArray32.t;
    ...
    var param_13:BArray1536.t;
    var result_5:BArray1536.t;
    var param_14:BArray1536.t;
    var param_15:BArray1536.t;
    var result_6:BArray512.t;
    var param_16:BArray1536.t;
    ...
    var param_26:BArray1536.t;
    var result_13:BArray1536.t;
    var param_27:BArray512.t;
    var result_14:BArray512.t;
    var param_28:BArray1536.t;
    var param_29:BArray960.t;
    var result_15:BArray960.t;
    var param_30:BArray512.t;
    var param_31:BArray128.t;
    var result_16:BArray512.t;
    var result_17:BArray128.t;
    var b_result:BArray512.t;
    var b_result_0:BArray128.t;
    var b_param:BArray128.t;
    var b_result_1:BArray960.t;
    var b_param_0:BArray960.t;
    var b_bp:BArray1536.t;
    var b_s_ct:BArray1088.t;
    var b_result_2:BArray512.t;
    var b_result_3:BArray1536.t;
    var b_result_4:BArray512.t;
    var b_k:BArray512.t;
    ...
    var b_result_6:BArray1536.t;
    var b_param_1:BArray1536.t;
    var b_ep:BArray1536.t;
    var b_result_7:BArray512.t;
    var b_result_8:BArray1536.t;
    var b_param_2:BArray1536.t;
    var b_result_9:BArray512.t;
    var b_sp:BArray1536.t;
    var b_result_10:BArray512.t;
    var b_param_3:BArray1536.t;
    var b_aat:BArray4608.t;
    var b_result_11:BArray1536.t;
    var b_param_4:BArray1536.t;
    ...
    var b_param_7:BArray512.t;
    var b_result_15:BArray4608.t;
    var b_param_8:BArray32.t;
    var b_publicseed:BArray32.t;
    var b_result_16:BArray512.t;
    var b_param_9:BArray512.t;
    var b_result_17:BArray1536.t;
    var b_param_10:BArray1152.t;
    ...
    (trace___indcpa_enc ++
    [(Assert,
     (((BArray32.is_init b_msgp 0 32) /\ (BArray1184.is_init b_pk 0 1184)) /\
     (BArray32.is_init b_noiseseed 0 32)))]);
    b_publicseed <- (BArray32.init_arr (W8.of_int 0));
    b_k <- (BArray512.init_arr (W8.of_int 0));
    b_epp <- (BArray512.init_arr (W8.of_int 0));
    b_sp <- (BArray1536.init_arr (W8.of_int 0));
    b_ep <- (BArray1536.init_arr (W8.of_int 0));
    b_bp <- (BArray1536.init_arr (W8.of_int 0));
    b_s_ct <- b_ct;
    s_ct <- ct;
    b_param_10 <- (SBArray1184_1152.get_sub8 b_pk 0);
    param <- (SBArray1184_1152.get_sub8 pk 0);
    ...
    trace___indcpa_enc <-
    (trace___indcpa_enc ++
    [(Assert, (BArray1536.is_init b_result_17 0 1536))]);
    pkpv <- result;
    w <- 0;
    while ((w < 4)) {
      trace___indcpa_enc <-
      (trace___indcpa_enc ++
      [(Assert, ((0 <= ((144 + w) * 8)) /\ ((((144 + w) * 8) + 8) <= 1184)))]);
      t64 <- (BArray1184.get64d pk ((144 + w) * 8));
      (* Erased call to declassify *)
      trace___indcpa_enc <-
      (trace___indcpa_enc ++
    ...
    trace___indcpa_enc <-
    (trace___indcpa_enc ++
    [(Assert, (BArray4608.is_init b_result_15 0 4608))]);
    b_aat <- (BArray4608.init_arr (W8.of_int 255));
    aat <- result_1;
    ...
    while ((w < 3)) {
      ...
      (trace___indcpa_enc ++
      [(Assert,
       ((0 <= ((256 * w) * 2)) /\ ((((256 * w) * 2) + 512) <= 1536)))]);
      trace___indcpa_enc <-
      (trace___indcpa_enc ++
      [(Assert,
       ((0 <= ((w * 256) * 2)) /\ ((((w * 256) * 2) + 512) <= 1536)))]);
      b_param_7 <- (SBArray1536_512.get_sub16 b_sp (w * 256));
      param_6 <- (SBArray1536_512.get_sub16 sp_0 (w * 256));
      param_5 <- lnoiseseed;
      param_4 <- nonce;
      ...
      b_sp <-
      (SBArray1536_512.set_sub16 b_sp (256 * w)
      (BArray512.init_arr (W8.of_int 255)));
      sp_0 <- (SBArray1536_512.set_sub16 sp_0 (256 * w) result_2);
      w <- (w + 1);
    }
    lnoiseseed <- s_noiseseed;
    w <- 0;
    while ((w < 3)) {
      ...
      [(Assert,
       ((0 <= ((w * 256) * 2)) /\ ((((w * 256) * 2) + 512) <= 1536)))]);
      b_param_6 <- (SBArray1536_512.get_sub16 b_ep (w * 256));
      param_9 <- (SBArray1536_512.get_sub16 ep (w * 256));
      param_8 <- lnoiseseed;
      param_7 <- nonce;
      ...
      b_ep <-
      (SBArray1536_512.set_sub16 b_ep (256 * w)
      (BArray512.init_arr (W8.of_int 255)));
      ep <- (SBArray1536_512.set_sub16 ep (256 * w) result_3);
      w <- (w + 1);
    }
    nonce <- (W8.of_int 6);
    b_param_5 <- b_epp;
    ...
    trace___indcpa_enc <-
    (trace___indcpa_enc ++
    [(Assert, (BArray1536.is_init b_result_11 0 1536))]);
    sp_0 <- result_5;
    w <- 0;
    while ((w < 3)) {
      trace___indcpa_enc <-
      ...
      (trace___indcpa_enc ++
      [(Assert,
       ((0 <= ((w * 768) * 2)) /\ ((((w * 768) * 2) + 1536) <= 4608)))]);
      b_param_3 <- (SBArray4608_1536.get_sub16 b_aat (w * 768));
      param_15 <- (SBArray4608_1536.get_sub16 aat (w * 768));
      param_14 <- sp_0;
      (aux_1, aux_2, tmp__trace) <@ __polyvec_pointwise_acc (param_15,
      b_param_3, param_14, (BArray1536.init_arr (W8.of_int 255)));
      result_6 <- aux_1;
      b_result_10 <- aux_2;
      trace___indcpa_enc <- (trace___indcpa_enc ++ tmp__trace);
      trace___indcpa_enc <-
      ...
      b_bp <-
      (SBArray1536_512.set_sub16 b_bp (w * 256)
      (BArray512.init_arr (W8.of_int 255)));
      bp <- (SBArray1536_512.set_sub16 bp (w * 256) result_6);
      w <- (w + 1);
    }
    param_17 <- pkpv;
    param_16 <- sp_0;
    (aux_1, aux_2, tmp__trace) <@ __polyvec_pointwise_acc (param_17,
    (BArray1536.init_arr (W8.of_int 255)), param_16,
    (BArray1536.init_arr (W8.of_int 255)));
    result_7 <- aux_1;
    b_result_9 <- aux_2;
    trace___indcpa_enc <- (trace___indcpa_enc ++ tmp__trace);
    ...
    (BArray1536.init_arr (W8.of_int 255)), param_20, b_param_1);
    result_10 <- aux;
    b_result_6 <- aux_0;
    trace___indcpa_enc <- (trace___indcpa_enc ++ tmp__trace);
    trace___indcpa_enc <-
    ...
    trace___indcpa_enc <-
    (trace___indcpa_enc ++
    [(Assert, (BArray1536.is_init b_result_3 0 1536))]);
    bp <- result_13;
    param_27 <- v;
    ...
    b_ct <- b_s_ct;
    ct <- s_ct;
    b_param_0 <- (SBArray1088_960.get_sub8 b_ct 0);
    param_29 <- (SBArray1088_960.get_sub8 ct 0);
    param_28 <- bp;
    (result_15, b_result_1, tmp__trace) <@ __i_polyvec_compress (param_29,
    b_param_0, param_28, (BArray1536.init_arr (W8.of_int 255)));
    trace___indcpa_enc <- (trace___indcpa_enc ++ tmp__trace);
    trace___indcpa_enc <-
    (trace___indcpa_enc ++ [(Assert, (BArray960.is_init b_result_1 0 960))]);
    b_ct <-
    (SBArray1088_960.set_sub8 b_ct 0 (BArray960.init_arr (W8.of_int 255)));
    ct <- (SBArray1088_960.set_sub8 ct 0 result_15);
    b_param <- (SBArray1088_128.get_sub8 b_ct 960);
    param_31 <- (SBArray1088_128.get_sub8 ct 960);
    param_30 <- v;
    ...
    (trace___indcpa_enc ++
    [(Assert,
     ((BArray128.is_init b_result_0 0 128) /\
     (BArray512.is_init b_result 0 512)))]);
    b_ct <-
    (SBArray1088_128.set_sub8 b_ct 960 (BArray128.init_arr (W8.of_int 255)));
    ct <- (SBArray1088_128.set_sub8 ct 960 result_17);
    return (ct, b_ct, trace___indcpa_enc);
  }
  proc __indcpa_dec (msgp:BArray32.t, b_msgp:BArray32.t, ct:BArray1088.t,
                     b_ct:BArray1088.t, sk:BArray1152.t, b_sk:BArray1152.t) : 
  BArray32.t * BArray32.t * trace = {
    var aux:BArray1536.t;
    var aux_0:BArray1536.t;
    var aux_3:BArray32.t;
    ...
    var t:BArray512.t;
    var mp:BArray512.t;
    var param:BArray960.t;
    var param_0:BArray1536.t;
    var result:BArray1536.t;
    var param_1:BArray128.t;
    var param_2:BArray512.t;
    var result_0:BArray512.t;
    var param_3:BArray1152.t;
    var result_1:BArray1536.t;
    var param_4:BArray1536.t;
    var result_2:BArray1536.t;
    var param_5:BArray1536.t;
    var param_6:BArray1536.t;
    var result_3:BArray512.t;
    var param_7:BArray512.t;
    var result_4:BArray512.t;
    var param_8:BArray512.t;
    ...
    (trace___indcpa_dec ++
    [(Assert,
     ((BArray1088.is_init b_ct 0 1088) /\ (BArray1152.is_init b_sk 0 1152)))]);
    b_v <- (BArray512.init_arr (W8.of_int 0));
    b_mp <- (BArray512.init_arr (W8.of_int 0));
    b_bp <- (BArray1536.init_arr (W8.of_int 0));
    b_param_4 <- b_bp;
    param_0 <- bp;
    b_param_3 <- (SBArray1088_960.get_sub8 b_ct 0);
    param <- (SBArray1088_960.get_sub8 ct 0);
    ...
    b_param_2 <- b_v;
    param_2 <- v;
    b_param_1 <- (SBArray1088_128.get_sub8 b_ct 960);
    param_1 <- (SBArray1088_128.get_sub8 ct 960);
    ...
    (BArray1152.init_arr (W8.of_int 255)));
    result_1 <- aux;
    b_result_6 <- aux_0;
    trace___indcpa_dec <- (trace___indcpa_dec ++ tmp__trace);
    trace___indcpa_dec <-
    ...
    (BArray1536.init_arr (W8.of_int 255)), param_5,
    (BArray1536.init_arr (W8.of_int 255)));
    result_3 <- aux_1;
    b_result_4 <- aux_2;
    trace___indcpa_dec <- (trace___indcpa_dec ++ tmp__trace);
  ...
  proc __verify (ctp:BArray1088.t, b_ctp:BArray1088.t, ctpc:BArray1088.t,
                 b_ctpc:BArray1088.t) : W64.t * trace = {
    var cnd:W64.t;
    var i:int;
    var t1:W8.t;
    var t2:W8.t;
    ...
    trace___verify <- [];
    trace___verify <-
    (trace___verify ++ [(Assert, (BArray1088.is_init b_ctp 0 1088))]);
    trace___verify <-
    (trace___verify ++ [(Assert, (BArray1088.is_init b_ctpc 0 1088))]);
    cnd <- (W64.of_int 0);
    i <- 0;
    while ((i < 1088)) {
      trace___verify <-
      (trace___verify ++ [(Assert, ((0 <= i) /\ ((i + 1) <= 1088)))]);
      t1 <- (BArray1088.get8d ctpc i);
      trace___verify <-
      (trace___verify ++ [(Assert, ((0 <= i) /\ ((i + 1) <= 1088)))]);
      t2 <- (BArray1088.get8 ctp i);
      t1 <- (t1 `^` t2);
      t64 <- (zeroextu64 t1);
      cnd <- (cnd `|` t64);
      i <- (i + 1);
  ...
  proc __crypto_kem_keypair_jazz (pk:BArray1184.t, b_pk:BArray1184.t,
                                  sk:BArray2400.t, b_sk:BArray2400.t,
                                  randomnessp:BArray64.t,
                                  b_randomnessp:BArray64.t) : BArray1184.t *
                                                              BArray1184.t *
                                                              BArray2400.t *
                                                              BArray2400.t *
                                                              trace = {
    ...
    var icsk:BArray1152.t;
    var s_skp:BArray2400.t;
    var i:int;
    var t64:W64.t;
    var h_pk:BArray32.t;
    var randomnessp2:BArray32.t;
    var param:BArray32.t;
    var param_0:BArray1152.t;
    var param_1:BArray1184.t;
    var result:BArray1152.t;
    var result_0:BArray1184.t;
    var param_2:BArray1184.t;
    var param_3:BArray32.t;
    var result_1:BArray32.t;
    var b_randomnessp2:BArray32.t;
    var b_h_pk:BArray32.t;
    var b_s_skp:BArray2400.t;
    var b_result:BArray32.t;
    var b_param:BArray32.t;
    var b_icsk:BArray1152.t;
    var b_result_0:BArray1152.t;
    var b_result_1:BArray1184.t;
    var b_param_0:BArray32.t;
    var b_param_1:BArray1152.t;
    var b_param_2:BArray1184.t;
    ...
    b_icsk <- (SBArray2400_1152.get_sub8 b_sk 0);
    icsk <- (SBArray2400_1152.get_sub8 sk 0);
    b_s_skp <- b_sk;
    s_skp <- sk;
    b_param_2 <- b_pk;
    param_1 <- pk;
    ...
    (trace___crypto_kem_keypair_jazz ++
    [(Assert,
     ((BArray1184.is_init b_result_1 0 1184) /\
     (BArray1152.is_init b_result_0 0 1152)))]);
    pk <- result_0;
    icsk <- result;
    b_sk <- b_s_skp;
    sk <- s_skp;
    b_sk <-
    (SBArray2400_1152.set_sub8 b_sk 0 (BArray1152.init_arr (W8.of_int 255)));
    sk <- (SBArray2400_1152.set_sub8 sk 0 icsk);
    i <- 0;
    while ((i < 148)) {
      trace___crypto_kem_keypair_jazz <-
      (trace___crypto_kem_keypair_jazz ++
      [(Assert, ((0 <= (i * 8)) /\ (((i * 8) + 8) <= 1184)))]);
      t64 <- (BArray1184.get64 pk i);
      trace___crypto_kem_keypair_jazz <-
      (trace___crypto_kem_keypair_jazz ++
      [(Assert, ((0 <= ((144 + i) * 8)) /\ ((((144 + i) * 8) + 8) <= 2400)))]);
      b_sk <-
      (BArray2400.set64d b_sk ((144 + i) * 8)
      (W64.of_int 18446744073709551615));
      sk <- (BArray2400.set64d sk ((144 + i) * 8) t64);
      i <- (i + 1);
    }
    b_s_skp <- b_sk;
    s_skp <- sk;
    ...
    param_3 <- h_pk;
    param_2 <- pk;
    (result_1, b_result, tmp__trace) <@ _sha3_256A_A1184 (param_3, b_param,
    param_2, (BArray1184.init_arr (W8.of_int 255)));
    trace___crypto_kem_keypair_jazz <-
    (trace___crypto_kem_keypair_jazz ++ tmp__trace);
    trace___crypto_kem_keypair_jazz <-
    (trace___crypto_kem_keypair_jazz ++
    ...
    while ((i < 4)) {
      ...
      trace___crypto_kem_keypair_jazz <-
      (trace___crypto_kem_keypair_jazz ++
      [(Assert, ((0 <= ((292 + i) * 8)) /\ ((((292 + i) * 8) + 8) <= 2400)))]);
      b_sk <-
      (BArray2400.set64d b_sk ((292 + i) * 8)
      (W64.of_int 18446744073709551615));
      sk <- (BArray2400.set64d sk ((292 + i) * 8) t64);
      i <- (i + 1);
    }
    ...
    while ((i < 4)) {
      ...
      trace___crypto_kem_keypair_jazz <-
      (trace___crypto_kem_keypair_jazz ++
      [(Assert, ((0 <= ((296 + i) * 8)) /\ ((((296 + i) * 8) + 8) <= 2400)))]);
      b_sk <-
      (BArray2400.set64d b_sk ((296 + i) * 8)
      (W64.of_int 18446744073709551615));
      sk <- (BArray2400.set64d sk ((296 + i) * 8) t64);
      i <- (i + 1);
    }
    b_pk <- (BArray1184.init_arr (W8.of_int 255));
    return (pk, b_pk, sk, b_sk, trace___crypto_kem_keypair_jazz);
  }
  proc __crypto_kem_enc_jazz (ct:BArray1088.t, b_ct:BArray1088.t,
                              shk:BArray32.t, b_shk:BArray32.t,
                              pk:BArray1184.t, b_pk:BArray1184.t,
                              randomnessp:BArray32.t,
                              b_randomnessp:BArray32.t) : BArray1088.t *
                                                          BArray1088.t *
                                                          BArray32.t *
                                                          BArray32.t * trace = {
    var s_pk:BArray1184.t;
    var s_shk:BArray32.t;
    var i:int;
    var t64:W64.t;
    var buf:BArray64.t;
    var kr:BArray64.t;
    var param:BArray1184.t;
    var param_0:BArray32.t;
    ...
    var param_3:BArray32.t;
    var param_4:BArray1184.t;
    var param_5:BArray32.t;
    var param_6:BArray1088.t;
    var result_1:BArray1088.t;
    var b_kr:BArray64.t;
    var b_s_shk:BArray32.t;
    var b_result:BArray1088.t;
    var b_param:BArray32.t;
    var b_param_0:BArray32.t;
    var b_param_1:BArray1088.t;
    var b_buf:BArray64.t;
    ...
    [(Assert,
     ...
     (BArray1184.is_init b_pk 0 1184)))]);
    b_buf <- (BArray64.init_arr (W8.of_int 0));
    ...
    param <- pk;
    (result, b_result_1, tmp__trace) <@ _sha3_256A_A1184 (param_0, b_param_4,
    param, (BArray1184.init_arr (W8.of_int 255)));
    trace___crypto_kem_enc_jazz <-
    ...
    param_5, b_param_0, param_4, (BArray1184.init_arr (W8.of_int 255)),
    param_3, b_param);
    trace___crypto_kem_enc_jazz <-
    (trace___crypto_kem_enc_jazz ++ tmp__trace);
    trace___crypto_kem_enc_jazz <-
    (trace___crypto_kem_enc_jazz ++
    [(Assert, (BArray1088.is_init b_result 0 1088))]);
    ct <- result_1;
    b_shk <- b_s_shk;
    shk <- s_shk;
    i <- 0;
    ...
    b_ct <- (BArray1088.init_arr (W8.of_int 255));
    return (ct, b_ct, shk, b_shk, trace___crypto_kem_enc_jazz);
  }
  proc __crypto_kem_dec_jazz (shk:BArray32.t, b_shk:BArray32.t,
                              ct:BArray1088.t, b_ct:BArray1088.t,
                              sk:BArray2400.t, b_sk:BArray2400.t) : BArray32.t *
                                                                    BArray32.t *
                                                                    trace = {
    var s_shk:BArray32.t;
    var s_ct:BArray1088.t;
    var s_sk:BArray2400.t;
    var buf:BArray64.t;
    var i:int;
    var t64:W64.t;
    var kr:BArray64.t;
    var ctc:BArray1088.t;
    var cnd:W64.t;
    var s_cnd:W64.t;
    var param:BArray1152.t;
    var param_0:BArray1088.t;
    ...
    var param_7:BArray1088.t;
    var result_1:BArray1088.t;
    var param_8:BArray1088.t;
    var param_9:BArray1088.t;
    var result_2:W64.t;
    var param_10:BArray1088.t;
    var param_11:BArray32.t;
    var param_12:BArray32.t;
    ...
    var b_param_0:BArray32.t;
    var b_param_1:BArray32.t;
    var b_s_sk:BArray2400.t;
    var b_s_shk:BArray32.t;
    var b_ctc:BArray1088.t;
    var b_result_1:BArray1088.t;
    var b_param_2:BArray32.t;
    var b_param_3:BArray1184.t;
    var b_param_4:BArray32.t;
    var b_param_5:BArray1088.t;
    var b_buf:BArray64.t;
    var b_result_2:BArray64.t;
    var b_param_6:BArray64.t;
    var b_param_7:BArray64.t;
    var b_result_3:BArray32.t;
    var b_param_8:BArray1152.t;
    ...
    (trace___crypto_kem_dec_jazz ++
    [(Assert,
     ((BArray1088.is_init b_ct 0 1088) /\ (BArray2400.is_init b_sk 0 2400)))]);
    b_buf <- (BArray64.init_arr (W8.of_int 0));
    b_kr <- (BArray64.init_arr (W8.of_int 0));
    b_ctc <- (BArray1088.init_arr (W8.of_int 0));
    b_s_shk <- b_shk;
    s_shk <- shk;
    s_ct <- ct;
    b_s_sk <- (BArray2400.init_arr (W8.of_int 255));
    s_sk <- sk;
    b_param_9 <- (SBArray64_32.get_sub8 b_buf 0);
    param_1 <- (SBArray64_32.get_sub8 buf 0);
    param_0 <- ct;
    b_param_8 <- (SBArray2400_1152.get_sub8 b_s_sk 0);
    param <- (SBArray2400_1152.get_sub8 s_sk 0);
    (result, b_result_3, tmp__trace) <@ __indcpa_dec (param_1, b_param_9,
    param_0, (BArray1088.init_arr (W8.of_int 255)), param, b_param_8);
    trace___crypto_kem_dec_jazz <-
    ...
    while ((i < 4)) {
      trace___crypto_kem_dec_jazz <-
      (trace___crypto_kem_dec_jazz ++
      [(Assert, ((0 <= ((i + 292) * 8)) /\ ((((i + 292) * 8) + 8) <= 2400)))]);
      t64 <- (BArray2400.get64d s_sk ((i + 292) * 8));
      trace___crypto_kem_dec_jazz <-
      (trace___crypto_kem_dec_jazz ++
      [(Assert, ((0 <= ((i + 4) * 8)) /\ ((((i + 4) * 8) + 8) <= 64)))]);
      b_buf <-
    ...
    b_param_3 <- (SBArray2400_1184.get_sub8 b_s_sk 1152);
    param_5 <- (SBArray2400_1184.get_sub8 s_sk 1152);
    ...
    trace___crypto_kem_dec_jazz <-
    (trace___crypto_kem_dec_jazz ++
    [(Assert, (BArray1088.is_init b_result_1 0 1088))]);
    ctc <- result_1;
    ct <- s_ct;
    param_9 <- ct;
    param_8 <- ctc;
    (result_2, tmp__trace) <@ __verify (param_9,
    (BArray1088.init_arr (W8.of_int 255)), param_8,
    ...
    b_param_1 <- b_shk;
    param_12 <- shk;
    b_param_0 <- (SBArray2400_32.get_sub8 b_s_sk 2368);
    param_11 <- (SBArray2400_32.get_sub8 s_sk 2368);
    param_10 <- ct;
    (result_3, b_result_0, tmp__trace) <@ _shake256_A32__A1120 (param_12,
  ...
  proc jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand (public_key:BArray1184.t,
                                                         b_public_key:BArray1184.t,
                                                         secret_key:BArray2400.t,
                                                         b_secret_key:BArray2400.t,
                                                         coins:BArray64.t,
                                                         b_coins:BArray64.t) : 
  BArray1184.t * BArray1184.t * BArray2400.t * BArray2400.t * W64.t * trace = {
    var r:W64.t;
    var rd:BArray64.t;
    var pk:BArray1184.t;
    var pkp:BArray1184.t;
    var sk:BArray2400.t;
    var skp:BArray2400.t;
    var rdp:BArray64.t;
    var param:BArray64.t;
    var param_0:BArray2400.t;
    var param_1:BArray1184.t;
    var result:BArray2400.t;
    var result_0:BArray1184.t;
    var b_sk:BArray2400.t;
    var b_pk:BArray1184.t;
    var b_skp:BArray2400.t;
    var b_pkp:BArray1184.t;
    var b_result:BArray2400.t;
    var b_result_0:BArray1184.t;
    var b_param:BArray2400.t;
    var b_param_0:BArray1184.t;
    var  _0:W64.t;
    var  _1:bool;
    var  _2:bool;
    ...
    var  _4:bool;
    var  _5:bool;
    var trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_pk <- witness;
    b_pkp <- witness;
    ...
    sk <- witness;
    skp <- witness;
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand <- [];
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand ++
    [(Assert, (BArray64.is_init b_coins 0 64))]);
    b_pk <- (BArray1184.init_arr (W8.of_int 0));
    b_sk <- (BArray2400.init_arr (W8.of_int 0));
     _0 <- (init_msf);
    (* Erased call to spill *)
    (* Erased call to spill *)
    rd <- (copy_64 coins);
    ...
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand ++ tmp__trace);
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand ++
    [(Assert,
     ((BArray1184.is_init b_result_0 0 1184) /\
     (BArray2400.is_init b_result 0 2400)))]);
    pkp <- result_0;
    skp <- result;
    (* Erased call to unspill *)
    (* Erased call to unspill *)
    ...
    b_public_key <- (BArray1184.init_arr (W8.of_int 255));
    b_secret_key <- (BArray2400.init_arr (W8.of_int 255));
    return (public_key, b_public_key, secret_key, b_secret_key, r,
           trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand);
  }
  proc jade_kem_mlkem_mlkem768_amd64_ref_keypair (public_key:BArray1184.t,
                                                  b_public_key:BArray1184.t,
                                                  secret_key:BArray2400.t,
                                                  b_secret_key:BArray2400.t) : 
  BArray1184.t * BArray1184.t * BArray2400.t * BArray2400.t * W64.t * trace = {
    ...
    var param_1:BArray1184.t;
    var result:W64.t;
    var result_0:BArray2400.t;
    var result_1:BArray1184.t;
    var b_result:BArray2400.t;
    var b_result_0:BArray1184.t;
    var b_param:BArray2400.t;
    var b_param_0:BArray1184.t;
    var trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_result <- witness;
    b_result_0 <- witness;
    ...
    result_0 <- witness;
    result_1 <- witness;
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair <- [];
    ...
    jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand (param_1, b_param_0,
    param_0, b_param, param, (BArray64.init_arr (W8.of_int 255)));
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair ++ tmp__trace);
    trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_keypair ++
    [(Assert,
     ((BArray1184.is_init b_result_0 0 1184) /\
  ...
  proc jade_kem_mlkem_mlkem768_amd64_ref_enc_derand (ciphertext:BArray1088.t,
                                                     b_ciphertext:BArray1088.t,
                                                     shared_secret:BArray32.t,
                                                     b_shared_secret:BArray32.t,
                                                     public_key:BArray1184.t,
                                                     b_public_key:BArray1184.t,
                                                     coins:BArray32.t,
                                                     b_coins:BArray32.t) : 
  BArray1088.t * BArray1088.t * BArray32.t * BArray32.t * W64.t * trace = {
    var r:W64.t;
    var pk:BArray1184.t;
    var rd:BArray32.t;
    var ct:BArray1088.t;
    var ctp:BArray1088.t;
    var pkp:BArray1184.t;
    var shk:BArray32.t;
    var shkp:BArray32.t;
    var rdp:BArray32.t;
    var param:BArray32.t;
    var param_0:BArray1184.t;
    var param_1:BArray32.t;
    var param_2:BArray1088.t;
    var result:BArray32.t;
    var result_0:BArray1088.t;
    var b_shk:BArray32.t;
    var b_ct:BArray1088.t;
    var b_shkp:BArray32.t;
    var b_ctp:BArray1088.t;
    var b_result:BArray32.t;
    var b_result_0:BArray1088.t;
    var b_param:BArray32.t;
    var b_param_0:BArray1088.t;
    var  _0:W64.t;
    var  _1:bool;
    ...
    var  _4:bool;
    var  _5:bool;
    var trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand:trace;
    b_ct <- witness;
    b_ctp <- witness;
    b_param <- witness;
    b_param_0 <- witness;
    ...
    shk <- witness;
    shkp <- witness;
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand <- [];
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand ++
    [(Assert,
     ((BArray32.is_init b_coins 0 32) /\
     (BArray1184.is_init b_public_key 0 1184)))]);
    b_shk <- (BArray32.init_arr (W8.of_int 0));
    b_ct <- (BArray1088.init_arr (W8.of_int 0));
     _0 <- (init_msf);
    (* Erased call to spill *)
    (* Erased call to spill *)
    ...
    (BArray1184.init_arr (W8.of_int 255)), param,
    (BArray32.init_arr (W8.of_int 255)));
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand ++ tmp__trace);
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand ++
    [(Assert,
     ((BArray1088.is_init b_result_0 0 1088) /\
    ...
    b_ciphertext <- (BArray1088.init_arr (W8.of_int 255));
    return (ciphertext, b_ciphertext, shared_secret, b_shared_secret, 
           r, trace_jade_kem_mlkem_mlkem768_amd64_ref_enc_derand);
  }
  proc jade_kem_mlkem_mlkem768_amd64_ref_enc (ciphertext:BArray1088.t,
                                              b_ciphertext:BArray1088.t,
                                              shared_secret:BArray32.t,
                                              b_shared_secret:BArray32.t,
                                              public_key:BArray1184.t,
  ...
  BArray1088.t * BArray1088.t * BArray32.t * BArray32.t * W64.t * trace = {
    ...
    var b_param:BArray32.t;
    var b_param_0:BArray1088.t;
    var trace_jade_kem_mlkem_mlkem768_amd64_ref_enc:trace;
    b_param <- witness;
    b_param_0 <- witness;
    b_result <- witness;
    b_result_0 <- witness;
    ...
    result_0 <- witness;
    result_1 <- witness;
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc <- [];
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc ++
    [(Assert, (BArray1184.is_init b_public_key 0 1184))]);
    ...
    param <- rdp;
    (result_1, b_result_0, result_0, b_result, result, tmp__trace) <@ 
    jade_kem_mlkem_mlkem768_amd64_ref_enc_derand (param_2, b_param_0,
    param_1, b_param, param_0, (BArray1184.init_arr (W8.of_int 255)), 
    param, (BArray32.init_arr (W8.of_int 255)));
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc ++ tmp__trace);
    trace_jade_kem_mlkem_mlkem768_amd64_ref_enc <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_enc ++
    [(Assert,
     ((BArray1088.is_init b_result_0 0 1088) /\
    ...
    b_ciphertext <- (BArray1088.init_arr (W8.of_int 255));
    return (ciphertext, b_ciphertext, shared_secret, b_shared_secret, 
           r, trace_jade_kem_mlkem_mlkem768_amd64_ref_enc);
  }
  proc jade_kem_mlkem_mlkem768_amd64_ref_dec (shared_secret:BArray32.t,
                                              b_shared_secret:BArray32.t,
                                              ciphertext:BArray1088.t,
                                              b_ciphertext:BArray1088.t,
                                              secret_key:BArray2400.t,
                                              b_secret_key:BArray2400.t) : 
  BArray32.t * BArray32.t * W64.t * trace = {
    ...
    var  _4:bool;
    var  _5:bool;
    var trace_jade_kem_mlkem_mlkem768_amd64_ref_dec:trace;
    b_param <- witness;
    b_result <- witness;
    b_shk <- witness;
    b_shkp <- witness;
    ...
    sk <- witness;
    skp <- witness;
    trace_jade_kem_mlkem_mlkem768_amd64_ref_dec <- [];
    trace_jade_kem_mlkem_mlkem768_amd64_ref_dec <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_dec ++
    [(Assert,
     ((BArray1088.is_init b_ciphertext 0 1088) /\
     (BArray2400.is_init b_secret_key 0 2400)))]);
    b_shk <- (BArray32.init_arr (W8.of_int 0));
     _0 <- (init_msf);
    (* Erased call to spill *)
    ...
    b_param, param_0, (BArray1088.init_arr (W8.of_int 255)), param,
    (BArray2400.init_arr (W8.of_int 255)));
    trace_jade_kem_mlkem_mlkem768_amd64_ref_dec <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_dec ++ tmp__trace);
    trace_jade_kem_mlkem_mlkem768_amd64_ref_dec <-
    (trace_jade_kem_mlkem_mlkem768_amd64_ref_dec ++
    [(Assert, (BArray32.is_init b_result 0 32))]);
    shkp <- result;
...
op a1088____a_ilen_read_upto8_at_spec _buf _b_buf _offset _dELTA _lEN _tRAIL _cUR _aT =
   hoare [M(Syscall).a1088____a_ilen_read_upto8_at :
   (((_aT = aT) /\
    ((_cUR = cUR) /\
    ((_tRAIL = tRAIL) /\
    ((_lEN = lEN) /\
   ...
   (((0 <= ((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8))) /\
    (((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8)) <= 18446744073709551615)) /\
   (((0 <= 1088) /\ (1088 <= 18446744073709551615)) /\
   ((((((BArray1088.is_init _b_buf (_offset + _dELTA) ((_lEN < 8) ? _lEN : 8)
        ) /\
       (0 <= _dELTA)) /\
      (0 <= _offset)) /\
     (((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8)) <= 1088)) /\
    (0 <= _tRAIL)) /\
   (_tRAIL < 256)))))))))))))))))))))))))))))))))))))))))))))))) ==>
   ((true /\
    (true /\
...
op a1088____addstate_ref_spec _st _b_st _aT _buf _b_buf _offset __LEN __TRAILB =
   hoare [M(Syscall).a1088____addstate_ref :
   (((__TRAILB = _TRAILB) /\
    ((__LEN = _LEN) /\
    ((_offset = offset) /\
    ((_b_buf = b_buf) /\
   ...
   (((0 <= (_offset + __LEN)) /\ ((_offset + __LEN) <= 18446744073709551615)) /\
   (((0 <= 1088) /\ (1088 <= 18446744073709551615)) /\
   (((((0 <= _offset) /\ (0 <= __LEN)) /\ ((_offset + __LEN) <= 1088)) /\
    (BArray1088.is_init _b_buf _offset __LEN)) /\
   (BArray200.is_init _b_st 0 200))))))))))))))))))))) ==>
   (((true /\ (true /\ ((0 <= res.`4) /\ (res.`4 <= 18446744073709551615)))) /\
    (true /\
    (true /\
...
op a1088____absorb_ref_spec _st _b_st _aT _buf _b_buf __TRAILB __RATE8 =
   hoare [M(Syscall).a1088____absorb_ref :
   (((__RATE8 = _RATE8) /\
    ((__TRAILB = _TRAILB) /\
    ((_b_buf = b_buf) /\
    ((_buf = buf) /\ ((_aT = aT) /\ ((_b_st = b_st) /\ (_st = st))))))) /\
   ...
   ((((((((0 < __RATE8) /\ (__RATE8 < 200)) /\ (0 <= __TRAILB)) /\
      ...
      (0 <= _aT)) /\
     (_aT < __RATE8)) /\
    (BArray1088.is_init _b_buf 0 1088)) /\
   (BArray200.is_init _b_st 0 (7 * 32))))))))))) ==>
   ((BArray200.is_init res.`2 0 (7 * 32)) /\ (valid res.`4))].

op a1184____a_ilen_read_upto8_at_spec _buf _b_buf _offset _dELTA _lEN _tRAIL _cUR _aT =
   hoare [M(Syscall).a1184____a_ilen_read_upto8_at :
   (((_aT = aT) /\
    ((_cUR = cUR) /\
    ((_tRAIL = tRAIL) /\
    ((_lEN = lEN) /\
   ...
   (((0 <= ((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8))) /\
    (((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8)) <= 18446744073709551615)) /\
   (((0 <= 1184) /\ (1184 <= 18446744073709551615)) /\
   ((((((BArray1184.is_init _b_buf (_offset + _dELTA) ((_lEN < 8) ? _lEN : 8)
        ) /\
       (0 <= _dELTA)) /\
      (0 <= _offset)) /\
     (((_offset + _dELTA) + ((_lEN < 8) ? _lEN : 8)) <= 1184)) /\
    (0 <= _tRAIL)) /\
   (_tRAIL < 256)))))))))))))))))))))))))))))))))))))))))))))))) ==>
   ((true /\
    (true /\
...
op a1184____addstate_ref_spec _st _b_st _aT _buf _b_buf _offset __LEN __TRAILB =
   hoare [M(Syscall).a1184____addstate_ref :
   (((__TRAILB = _TRAILB) /\
    ((__LEN = _LEN) /\
    ((_offset = offset) /\
    ((_b_buf = b_buf) /\
   ...
   (((0 <= (_offset + __LEN)) /\ ((_offset + __LEN) <= 18446744073709551615)) /\
   (((0 <= 1184) /\ (1184 <= 18446744073709551615)) /\
   (((((0 <= _offset) /\ (0 <= __LEN)) /\ ((_offset + __LEN) <= 1184)) /\
    (BArray1184.is_init _b_buf _offset __LEN)) /\
   (BArray200.is_init _b_st 0 200))))))))))))))))))))) ==>
   (((true /\ (true /\ ((0 <= res.`4) /\ (res.`4 <= 18446744073709551615)))) /\
    (true /\
    (true /\
...
op a1184____absorb_ref_spec _st _b_st _aT _buf _b_buf __TRAILB __RATE8 =
   hoare [M(Syscall).a1184____absorb_ref :
   (((__RATE8 = _RATE8) /\
    ((__TRAILB = _TRAILB) /\
    ((_b_buf = b_buf) /\
    ((_buf = buf) /\ ((_aT = aT) /\ ((_b_st = b_st) /\ (_st = st))))))) /\
   ...
   ((((((((0 < __RATE8) /\ (__RATE8 < 200)) /\ (0 <= __TRAILB)) /\
      ...
      (0 <= _aT)) /\
     (_aT < __RATE8)) /\
    (BArray1184.is_init _b_buf 0 1184)) /\
   (BArray200.is_init _b_st 0 (7 * 32))))))))))) ==>
   ((BArray200.is_init res.`2 0 (7 * 32)) /\ (valid res.`4))].
...
op _shake256_A32__A1120_spec _out _b_out _in0 _b_in0 _in1 _b_in1 =
   hoare [M(Syscall)._shake256_A32__A1120 :
   (((_b_in1 = b_in1) /\
    ((_in1 = in1) /\
    ((_b_in0 = b_in0) /\
    ((_in0 = in0) /\ ((_b_out = b_out) /\ (_out = out)))))) /\
   ((BArray32.is_init _b_in0 0 32) /\ (BArray1088.is_init _b_in1 0 1088))) ==>
...
op _sha3_256A_A1184_spec _out _b_out _in _b_in =
   hoare [M(Syscall)._sha3_256A_A1184 :
   (((_b_in = b_in) /\ ((_in = in_0) /\ ((_b_out = b_out) /\ (_out = out)))) /\
   (BArray1184.is_init _b_in 0 1184)) ==>
   ((BArray32.is_init res.`2 0 32) /\ (valid res.`3))].
...
op _i_poly_decompress_spec _rp _b_rp _ap _b_ap =
   ...
   (((_b_ap = b_ap) /\ ((_ap = ap) /\ ((_b_rp = b_rp) /\ (_rp = rp)))) /\
   (BArray128.is_init _b_ap 0 128)) ==>
   ((BArray512.is_init res.`2 0 (2 * 256)) /\ (valid res.`3))].

op __polyvec_add2_spec _r _b_r _b _b_b =
   hoare [M(Syscall).__polyvec_add2 :
   (((_b_b = b_b) /\ ((_b = b) /\ ((_b_r = b_r) /\ (_r = r)))) /\
   ((BArray1536.is_init _b_b 0 1536) /\ (BArray1536.is_init _b_r 0 1536))) ==>
   ((BArray1536.is_init res.`2 0 1536) /\ (valid res.`3))].

op __polyvec_csubq_spec _r _b_r =
   hoare [M(Syscall).__polyvec_csubq :
   (((_b_r = b_r) /\ (_r = r)) /\ (BArray1536.is_init _b_r 0 1536)) ==>
   ((BArray1536.is_init res.`2 0 1536) /\ (valid res.`3))].

op __i_polyvec_frombytes_spec _ap _b_ap =
   hoare [M(Syscall).__i_polyvec_frombytes :
   (((_b_ap = b_ap) /\ (_ap = ap)) /\ (BArray1152.is_init _b_ap 0 1152)) ==>
   ((BArray1536.is_init res.`2 0 1536) /\ (valid res.`3))].
...
op __polyvec_pointwise_acc_spec _a _b_a _b _b_b =
   ...
   ((BArray1536.is_init _b_b 0 1536) /\ (BArray1536.is_init _b_a 0 1536))) ==>
   ((BArray512.is_init res.`2 0 512) /\ (valid res.`3))].
...
op __i_polyvec_tobytes_spec _rp _b_rp _a _b_a =
   ...
   (((_b_a = b_a) /\ ((_a = a) /\ ((_b_rp = b_rp) /\ (_rp = rp)))) /\
   (BArray1536.is_init _b_a 0 (2 * (3 * 256)))) ==>
   ((BArray1152.is_init res.`2 0 (3 * 384)) /\ (valid res.`3))].

op __i_polyvec_compress_spec _rp _b_rp _a _b_a =
   hoare [M(Syscall).__i_polyvec_compress :
   (((_b_a = b_a) /\ ((_a = a) /\ ((_b_rp = b_rp) /\ (_rp = rp)))) /\
   (BArray1536.is_init _b_a 0 ((3 * 256) * 2))) ==>
   ((BArray960.is_init res.`2 0 (3 * 320)) /\ (valid res.`3))].

op __i_polyvec_decompress_spec _rp _b_rp _ap _b_ap =
   hoare [M(Syscall).__i_polyvec_decompress :
   (((_b_ap = b_ap) /\ ((_ap = ap) /\ ((_b_rp = b_rp) /\ (_rp = rp)))) /\
   (BArray960.is_init _b_ap 0 (3 * 320))) ==>
   ((BArray1536.is_init res.`2 0 ((3 * 256) * 2)) /\ (valid res.`3))].
...
op __gen_matrix_spec _seed _b_seed _transposed =
   ...
   ((BArray4608.is_init res.`2 0 ((3 * (3 * 256)) * 2)) /\ (valid res.`3))].
...
op __indcpa_keypair_spec _pk _b_pk _sk _b_sk _randomnessp _b_randomnessp =
   ...
   (((BArray1184.is_init res.`2 0 ((3 * 384) + 32)) /\
    (BArray1152.is_init res.`4 0 (3 * 384))) /\
   (valid res.`5))].
...
op __indcpa_enc_spec _ct _b_ct _msgp _b_msgp _pk _b_pk _noiseseed _b_noiseseed =
   ...
   (((BArray32.is_init _b_msgp 0 32) /\
    (BArray1184.is_init _b_pk 0 ((3 * 384) + 32))) /\
   (BArray32.is_init _b_noiseseed 0 32))) ==>
   ((BArray1088.is_init res.`2 0 ((3 * 320) + 128)) /\ (valid res.`3))].
...
op __indcpa_dec_spec _msgp _b_msgp _ct _b_ct _sk _b_sk =
   ...
   ((BArray1088.is_init _b_ct 0 ((3 * 320) + 128)) /\
   (BArray1152.is_init _b_sk 0 (3 * 384)))) ==>
   ((BArray32.is_init res.`2 0 32) /\ (valid res.`3))].
...
op __verify_spec _ctp _b_ctp _ctpc _b_ctpc =
   ...
   ((BArray1088.is_init _b_ctpc 0 1088) /\
   (BArray1088.is_init _b_ctp 0 1088))) ==> (true /\ (valid res.`2))].
...
op __crypto_kem_keypair_jazz_spec _pk _b_pk _sk _b_sk _randomnessp _b_randomnessp =
   ...
   (((BArray1184.is_init res.`2 0 ((3 * 384) + 32)) /\
    (BArray2400.is_init res.`4 0 ((((3 * 384) + ((3 * 384) + 32)) + 32) + 32)
    )) /\
   (valid res.`5))].
...
op __crypto_kem_enc_jazz_spec _ct _b_ct _shk _b_shk _pk _b_pk _randomnessp _b_randomnessp =
   ...
   ((BArray32.is_init _b_randomnessp 0 32) /\
   (BArray1184.is_init _b_pk 0 ((3 * 384) + 32)))) ==>
   (((BArray1088.is_init res.`2 0 ((3 * 320) + 128)) /\
...
op __crypto_kem_dec_jazz_spec _shk _b_shk _ct _b_ct _sk _b_sk =
   ...
   ((BArray1088.is_init _b_ct 0 ((3 * 320) + 128)) /\
   (BArray2400.is_init _b_sk 0 ((((3 * 384) + ((3 * 384) + 32)) + 32) + 32)))) ==>
   ((BArray32.is_init res.`2 0 32) /\ (valid res.`3))].

op jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand_spec _public_key _b_public_key _secret_key _b_secret_key _coins _b_coins =
   hoare [M(Syscall).jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand :
   (((_b_coins = b_coins) /\
    ((_coins = coins) /\
...
op jade_kem_mlkem_mlkem768_amd64_ref_keypair_spec _public_key _b_public_key _secret_key _b_secret_key =
   hoare [M(Syscall).jade_kem_mlkem_mlkem768_amd64_ref_keypair :
   (((_b_secret_key = b_secret_key) /\
    ((_secret_key = secret_key) /\
    ((_b_public_key = b_public_key) /\ (_public_key = public_key)))) /\
   true) ==>
...
op jade_kem_mlkem_mlkem768_amd64_ref_enc_derand_spec _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key _coins _b_coins =
   hoare [M(Syscall).jade_kem_mlkem_mlkem768_amd64_ref_enc_derand :
   (((_b_coins = b_coins) /\
    ((_coins = coins) /\
   ...
   (BArray1184.is_init _b_public_key 0 ((3 * 384) + 32)))) ==>
   (((BArray1088.is_init res.`2 0 ((3 * 320) + 128)) /\
    (BArray32.is_init res.`4 0 32)) /\
   (valid res.`6))].

op jade_kem_mlkem_mlkem768_amd64_ref_enc_spec _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key =
   hoare [M(Syscall).jade_kem_mlkem_mlkem768_amd64_ref_enc :
   (((_b_public_key = b_public_key) /\
    ((_public_key = public_key) /\
    ((_b_shared_secret = b_shared_secret) /\
    ((_shared_secret = shared_secret) /\
...
op jade_kem_mlkem_mlkem768_amd64_ref_dec_spec _shared_secret _b_shared_secret _ciphertext _b_ciphertext _secret_key _b_secret_key =
   hoare [M(Syscall).jade_kem_mlkem_mlkem768_amd64_ref_dec :
   (((_b_secret_key = b_secret_key) /\
    ((_secret_key = secret_key) /\
    ...
    ((_b_shared_secret = b_shared_secret) /\
    (_shared_secret = shared_secret)))))) /\
   ((BArray1088.is_init _b_ciphertext 0 ((3 * 320) + 128)) /\
   (BArray2400.is_init _b_secret_key 0
   ((((3 * 384) + ((3 * 384) + 32)) + 32) + 32)))) ==>
