...
L_gen_matrix_buf_rejection$24:
	...
	movq	%rbp, %r12
	andq	$255, %r12
	vmovq	(%rbx,%r12,8), %xmm6
	popcnt	%r12, %r12
	addq	%r15, %r12
	movq	%rbp, %r13
	shrq	$16, %r13
	andq	$255, %r13
	vmovq	(%rbx,%r13,8), %xmm7
	popcnt	%r13, %r13
	addq	%r12, %r13
	movq	%rbp, %r14
	shrq	$8, %r14
	andq	$255, %r14
	vmovq	(%rbx,%r14,8), %xmm8
	popcnt	%r14, %r14
	addq	%r13, %r14
	shrq	$24, %rbp
	andq	$255, %rbp
	vmovq	(%rbx,%rbp,8), %xmm9
	popcnt	%rbp, %rbp
	addq	%r14, %rbp
