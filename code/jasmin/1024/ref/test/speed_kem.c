...
int main(void)
{
  ...
  {
    t[i] = cpucycles();
    jade_kem_mlkem_mlkem1024_amd64_ref_keypair_derand(pk, sk, randomness0);
  }
  ...
  {
    t[i] = cpucycles();
    jade_kem_mlkem_mlkem1024_amd64_ref_enc_derand(ct, shk, pk, randomness1);
  }
  ...
  {
    t[i] = cpucycles();
    jade_kem_mlkem_mlkem1024_amd64_ref_dec(shk, ct, sk);
  }
