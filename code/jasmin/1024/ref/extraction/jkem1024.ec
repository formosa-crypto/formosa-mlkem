...
require import
Array5 Array8 Array24 Array25 Array32 Array33 Array34 Array64 Array128
Array160 Array168 Array200 Array256 Array1024 Array1408 Array1568 Array4096
WArray8 WArray16 WArray32 WArray33 WArray34 WArray40 WArray64 WArray128
WArray160 WArray168 WArray192 WArray200 WArray256 WArray512 WArray1408
WArray1568 WArray2048 WArray8192.
...
module M = {
  ...
  proc _shake256_1600_32 (out:W64.t, in0:W64.t, in1:W64.t) : unit = {
    ...
    (st,  _2,  _3) <@ __absorb_imem_ref (st, 32, in1, 1568, 136, 31);
    (* Erased call to unspill *)
  ...
  proc _isha3_256_M1568 (out:W8.t Array32.t, in_0:W64.t) : W8.t Array32.t = {
    ...
    st <- st_s;
    st <@ __state_init_ref (st);
    (st,  _0,  _1) <@ __absorb_imem_ref (st, 0, in_0, 1568, 136, 6);
    offset <- (W64.of_int 0);
    (* Erased call to unspill *)
  ...
  proc _poly_compress (rp:W64.t, a:W16.t Array256.t) : W16.t Array256.t = {
    ...
    while ((i < inc)) {
      ...
      c0 <- (c0 `|` c1);
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + (W64.of_int (i * 5)))) c0);
      c0 <- t.[1];
      c0 <- (c0 `>>` (W8.of_int 3));
      c1 <- t.[2];
      c1 <- (c1 `<<` (W8.of_int 2));
      ...
      c0 <- (c0 `|` c2);
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + (W64.of_int ((i * 5) + 1)))) c0);
      c0 <- t.[3];
      c0 <- (c0 `>>` (W8.of_int 1));
      c1 <- t.[4];
      c1 <- (c1 `<<` (W8.of_int 4));
      c0 <- (c0 `|` c1);
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + (W64.of_int ((i * 5) + 2)))) c0);
      c0 <- t.[4];
      c0 <- (c0 `>>` (W8.of_int 4));
      c1 <- t.[5];
      c1 <- (c1 `<<` (W8.of_int 1));
      ...
      c0 <- (c0 `|` c2);
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + (W64.of_int ((i * 5) + 3)))) c0);
      c0 <- t.[6];
      c0 <- (c0 `>>` (W8.of_int 2));
      c1 <- t.[7];
      c1 <- (c1 `<<` (W8.of_int 3));
      c0 <- (c0 `|` c1);
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + (W64.of_int ((i * 5) + 4)))) c0);
      i <- (i + 1);
    }
    return a;
  }
  proc _i_poly_compress (rp:W8.t Array160.t, a:W16.t Array256.t) : W8.t Array160.t *
    ...
    while ((i \ult (W64.of_int 256))) {
      ...
      c0 <- (c0 `|` c1);
      c0 <- (c0 `|` c2);
      rp.[(W64.to_uint (k + (W64.of_int 1)))] <- c0;
      c0 <- t.[3];
      c0 <- (c0 `>>` (W8.of_int 1));
      c1 <- t.[4];
      c1 <- (c1 `<<` (W8.of_int 4));
      c0 <- (c0 `|` c1);
      rp.[(W64.to_uint (k + (W64.of_int 2)))] <- c0;
      c0 <- t.[4];
      c0 <- (c0 `>>` (W8.of_int 4));
      c1 <- t.[5];
      c1 <- (c1 `<<` (W8.of_int 1));
      ...
      c0 <- (c0 `|` c1);
      c0 <- (c0 `|` c2);
      rp.[(W64.to_uint (k + (W64.of_int 3)))] <- c0;
      c0 <- t.[6];
      c0 <- (c0 `>>` (W8.of_int 2));
      c1 <- t.[7];
      c1 <- (c1 `<<` (W8.of_int 3));
      c0 <- (c0 `|` c1);
      rp.[(W64.to_uint (k + (W64.of_int 4)))] <- c0;
      k <- (k + (W64.of_int 5));
    }
    return (rp, a);
  }
  proc _poly_decompress (rp:W16.t Array256.t, ap:W64.t) : W16.t Array256.t = {
    ...
    j <- (W64.of_int 0);
    while ((i \ult (W64.of_int 256))) {
      c0 <- (loadW8 Glob.mem (W64.to_uint (ap + j)));
      t.[0] <- c0;
      j <- (j + (W64.of_int 1));
      c0 <- (c0 `>>` (W8.of_int 5));
      c1 <- (loadW8 Glob.mem (W64.to_uint (ap + j)));
      c2 <- c1;
      c1 <- (c1 `<<` (W8.of_int 3));
      c0 <- (c0 `|` c1);
      t.[1] <- c0;
      ...
      while ((k < 8)) {
        ...
        d0 <- (d0 + (W32.of_int 16));
        d0 <- (d0 `>>` (W8.of_int 5));
        rp.[(W64.to_uint i)] <- (truncateu16 d0);
        i <- (i + (W64.of_int 1));
        k <- (k + 1);
      }
    }
  ...
  proc __polyvec_compress (rp:W64.t, a:W16.t Array1024.t) : unit = {
    ...
    while ((i \ult (W64.of_int (4 * 256)))) {
      k <- 0;
      while ((k < 8)) {
        d0 <- (zeroextu64 aa.[(W64.to_uint i)]);
        d0 <- (d0 `<<` (W8.of_int 11));
      ...
      b <- t.[2];
      b <- (b `>>` (W8.of_int 2));
      Glob.mem <- (storeW8 Glob.mem (W64.to_uint (rp + j)) (truncateu8 b));
      j <- (j + (W64.of_int 1));
      b <- t.[2];
      b <- (b `>>` (W8.of_int 10));
      c <- t.[3];
      ...
      t.[7] <- (t.[7] `>>` (W8.of_int 3));
      Glob.mem <-
      (storeW8 Glob.mem (W64.to_uint (rp + j)) (truncateu8 t.[7]));
      j <- (j + (W64.of_int 1));
    }
    return ();
  }
  ...
  W8.t Array1408.t = {
    ...
    while ((i \ult (W64.of_int (4 * 256)))) {
      ...
      j <- (j + (W64.of_int 1));
      t.[7] <- (t.[7] `>>` (W8.of_int 3));
      rp.[(W64.to_uint j)] <- (truncateu8 t.[7]);
      j <- (j + (W64.of_int 1));
    }
    return rp;
  }
  proc __polyvec_decompress (ap:W64.t) : W16.t Array1024.t = {
    var r:W16.t Array1024.t;
    var i:W64.t;
    var j:W64.t;
    var t0:W32.t;
    ...
    j <- (W64.of_int 0);
    while ((i \ult (W64.of_int (4 * 256)))) {
      t0 <- (zeroextu32 (loadW8 Glob.mem (W64.to_uint (ap + j))));
      j <- (j + (W64.of_int 1));
      t1 <- (zeroextu32 (loadW8 Glob.mem (W64.to_uint (ap + j))));
      j <- (j + (W64.of_int 1));
      d1 <- t1;
      d1 <- (d1 `<<` (W8.of_int 8));
      t0 <- (t0 `|` d1);
      ...
      t0 <- (t0 `>>` (W8.of_int 11));
      r.[(W64.to_uint i)] <- (truncateu16 t0);
      i <- (i + (W64.of_int 1));
      t0 <- (zeroextu32 (loadW8 Glob.mem (W64.to_uint (ap + j))));
      j <- (j + (W64.of_int 1));
      d0 <- t1;
      ...
      d0 <- (d0 `>>` (W8.of_int 11));
      r.[(W64.to_uint i)] <- (truncateu16 d0);
      i <- (i + (W64.of_int 1));
      t1 <- (zeroextu32 (loadW8 Glob.mem (W64.to_uint (ap + j))));
      j <- (j + (W64.of_int 1));
      t2 <- (zeroextu32 (loadW8 Glob.mem (W64.to_uint (ap + j))));
      j <- (j + (W64.of_int 1));
      t0 <- (t0 `>>` (W8.of_int 6));
      d0 <- t1;
      d0 <- (d0 `<<` (W8.of_int 2));
  ...
  unit = {
    ...
    nonce <- (W8.of_int 3);
    aux <@ _poly_getnoise ((Array256.init
                           (fun i_0 => skpv.[((3 * 256) + i_0)])),
    s_noiseseed, nonce);
    skpv <-
    (Array1024.init
    (fun i_0 => (if ((3 * 256) <= i_0 < ((3 * 256) + 256)) then aux.[
                                                                (i_0 -
                                                                (3 * 256))] else 
                skpv.[i_0]))
    );
    ...
    nonce <- (W8.of_int 7);
    aux <@ _poly_getnoise ((Array256.init (fun i_0 => e.[((3 * 256) + i_0)])),
    s_noiseseed, nonce);
    e <-
    (Array1024.init
    (fun i_0 => (if ((3 * 256) <= i_0 < ((3 * 256) + 256)) then aux.[
  ...
  proc __indcpa_enc (sctp:W64.t, msgp:W8.t Array32.t, pkp:W64.t,
    ...
    nonce <- (W8.of_int 7);
    aux <@ _poly_getnoise ((Array256.init (fun i_0 => ep.[((3 * 256) + i_0)])
                           ),
    s_noiseseed, nonce);
    ep <-
    (Array1024.init
  ...
  proc __iindcpa_enc (ctp:W8.t Array1568.t, msgp:W8.t Array32.t, pkp:W64.t,
    ...
    v <@ __poly_reduce (v);
    ctp <- sctp;
    aux_0 <@ __i_polyvec_compress ((Array1408.init
                                   (fun i_0 => ctp.[(0 + i_0)])),
    bp);
    ctp <-
    (Array1568.init
    (fun i_0 => (if (0 <= i_0 < (0 + 1408)) then aux_0.[(i_0 - 0)] else 
                ctp.[i_0]))
    );
    ...
    ctp <-
    (Array1568.init
    (fun i_0 => (if ((4 * 352) <= i_0 < ((4 * 352) + 160)) then aux_1.[
                                                                (i_0 -
                                                                (4 * 352))] else 
                ctp.[i_0]))
    );
  ...
  proc __crypto_kem_keypair_jazz (pkp:W64.t, skp:W64.t,
    ...
    s_skp <- skp;
    pkp <- s_pkp;
    h_pk <@ _isha3_256_M1568 (h_pk, pkp);
    skp <- s_skp;
    i <- 0;
    while ((i < 4)) {
  ...
  proc __crypto_kem_enc_jazz (ctp:W64.t, shkp:W64.t, pkp:W64.t,
    ...
    pkp <- s_pkp;
    aux <@ _isha3_256_M1568 ((Array32.init (fun i_0 => buf.[(32 + i_0)])),
    pkp);
    buf <-
    (Array64.init
  ...
  proc jade_kem_mlkem_mlkem1024_amd64_ref_dec (shared_secret:W64.t,
                                               ciphertext:W64.t,
