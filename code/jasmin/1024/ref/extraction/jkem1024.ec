...
module M = {
  ...
  proc a32____addstate_array_ref (st:W64.t Array25.t, aT:int,
    ...
    if ((0 < lO)) {
      if (((lO + lEN) < 8)) {
        ...
        (dELTA,  _2,  _3, t) <@ a32____aread_subu64 (buf, offset, dELTA, 
        lEN, tRAILB);
        t <- (t `<<` (W8.of_int (8 * lO)));
        ...
        if ((8 <= lEN)) {
          ...
          (dELTA,  _0,  _1, t) <@ a32____aread_subu64 (buf, offset, dELTA,
          (8 - lO), tRAILB);
        }
        lEN <- (lEN - (8 - lO));
        aT <- (aT + (8 - lO));
    ...
    if (((0 < lO) \/ (tRAILB <> 0))) {
      ...
      (dELTA,  _4, tRAILB, t) <@ a32____aread_subu64 (buf, offset, dELTA, 
      lO, tRAILB);
      offset <- (offset + (W64.of_int dELTA));
      t <- (t `^` st.[(W64.to_uint at)]);
      st.[(W64.to_uint at)] <- t;
  ...
  proc a32____absorb_array_ref (st:W64.t Array25.t, aT:int,
                                buf:W8.t Array32.t, offset:W64.t, lEN:int,
    ...
    aLL <- (aT + lEN);
    if (((aT + lEN) < rATE8)) {
      (st, aT, offset) <@ a32____addstate_array_ref (st, aT, buf, offset,
      lEN, tRAILB);
      if ((tRAILB <> 0)) {
      ...
      if ((aT <> 0)) {
        (st,  _0, offset) <@ a32____addstate_array_ref (st, aT, buf, 
        offset, (rATE8 - aT), 0);
        lEN <- (lEN - (rATE8 - aT));
      ...
      while ((i \ult (W64.of_int iTERS))) {
        (st,  _1, offset) <@ a32____addstate_array_ref (st, 0, buf, offset,
        rATE8, 0);
        (* Erased call to spill *)
        st <@ _keccakf1600_ref (st);
        (* Erased call to unspill *)
      ...
      lEN <- (aLL %% rATE8);
      (st, aT, offset) <@ a32____addstate_array_ref (st, 0, buf, offset, 
      lEN, tRAILB);
      if ((tRAILB <> 0)) {
        st <@ __addratebit_ref (st, rATE8);
      } else {
  ...
  proc a1568____addstate_array_ref (st:W64.t Array25.t, aT:int,
    ...
    if ((0 < lO)) {
      if (((lO + lEN) < 8)) {
        ...
        (dELTA,  _2,  _3, t) <@ a1568____aread_subu64 (buf, offset, dELTA,
        lEN, tRAILB);
        t <- (t `<<` (W8.of_int (8 * lO)));
        t <- (t `^` st.[(W64.to_uint at)]);
        st.[(W64.to_uint at)] <- t;
        ...
        if ((8 <= lEN)) {
          ...
          (dELTA,  _0,  _1, t) <@ a1568____aread_subu64 (buf, offset, 
          dELTA, (8 - lO), tRAILB);
        }
        lEN <- (lEN - (8 - lO));
        aT <- (aT + (8 - lO));
    ...
    if (((0 < lO) \/ (tRAILB <> 0))) {
      ...
      (dELTA,  _4, tRAILB, t) <@ a1568____aread_subu64 (buf, offset, 
      dELTA, lO, tRAILB);
      offset <- (offset + (W64.of_int dELTA));
      t <- (t `^` st.[(W64.to_uint at)]);
      st.[(W64.to_uint at)] <- t;
  ...
  proc a1568____absorb_array_ref (st:W64.t Array25.t, aT:int,
                                  buf:W8.t Array1568.t, offset:W64.t,
                                  lEN:int, rATE8:int, tRAILB:int) : W64.t Array25.t *
                                                                    int *
                                                                    W64.t = {
    var aLL:int;
    var iTERS:int;
    ...
    aLL <- (aT + lEN);
    if (((aT + lEN) < rATE8)) {
      (st, aT, offset) <@ a1568____addstate_array_ref (st, aT, buf, offset,
      lEN, tRAILB);
      if ((tRAILB <> 0)) {
        st <@ __addratebit_ref (st, rATE8);
      } else {
      ...
      if ((aT <> 0)) {
        (st,  _0, offset) <@ a1568____addstate_array_ref (st, aT, buf,
        offset, (rATE8 - aT), 0);
        lEN <- (lEN - (rATE8 - aT));
        (* Erased call to spill *)
        st <@ _keccakf1600_ref (st);
      ...
      i <- (W64.of_int 0);
      while ((i \ult (W64.of_int iTERS))) {
        (st,  _1, offset) <@ a1568____addstate_array_ref (st, 0, buf, 
        offset, rATE8, 0);
        (* Erased call to spill *)
        st <@ _keccakf1600_ref (st);
        (* Erased call to unspill *)
      ...
      lEN <- (aLL %% rATE8);
      (st, aT, offset) <@ a1568____addstate_array_ref (st, 0, buf, offset,
      lEN, tRAILB);
      if ((tRAILB <> 0)) {
        st <@ __addratebit_ref (st, rATE8);
      } else {
  ...
  W8.t Array128.t = {
    ...
    (st,  _0,  _1) <@ a33____absorb_array_ref (st, 0, in_0, (W64.of_int 0),
    33, 136, 31);
    (aux, aux_0, aux_1) <@ a128____squeeze_array_ref (out, (W64.of_int 0),
    128, st, 136);
    out <- aux;
     _2 <- aux_0;
     _3 <-
  ...
  proc _shake256_A32__A1600 (out:W8.t Array32.t, in0:W8.t Array32.t,
    ...
    st <- st_s;
    st <@ __state_init_ref (st);
    (st,  _0,  _1) <@ a32____absorb_array_ref (st, 0, in0, (W64.of_int 0),
    32, 136, 0);
    (* Erased call to unspill *)
    (st,  _2,  _3) <@ a1568____absorb_array_ref (st, 32, in1, (W64.of_int 0),
    1568, 136, 31);
    (* Erased call to unspill *)
  ...
  proc _sha3_512A_A33 (out:W8.t Array64.t, in_0:W8.t Array33.t) : W8.t Array64.t = {
    ...
    (st,  _0,  _1) <@ a33____absorb_array_ref (st, 0, in_0, (W64.of_int 0),
    33, 72, 6);
    (aux, aux_0, aux_1) <@ a64____squeeze_array_ref (out, (W64.of_int 0), 64,
    st, 72);
    out <- aux;
     _2 <- aux_0;
     _3 <-
  ...
  W64.t Array25.t = {
    ...
    var  _1:W64.t;
    st <@ __state_init_ref (st);
    (st,  _0,  _1) <@ a34____absorb_array_ref (st, 0, in_0, (W64.of_int 0),
    34, 168, 31);
    return st;
  }
  ...
  W64.t Array25.t * W8.t Array168.t = {
    var  _0:W64.t;
    st <@ _keccakf1600_ref (st);
    (out,  _0) <@ a168____dumpstate_array_ref (out, (W64.of_int 0), 168, st);
    return (st, out);
  }
  ...
  W8.t Array32.t = {
    ...
    st <- st_s;
    st <@ __state_init_ref (st);
    (st,  _0,  _1) <@ a1568____absorb_array_ref (st, 0, in_0, (W64.of_int 0),
    1568, 136, 6);
    (* Erased call to unspill *)
    (aux, aux_0, aux_1) <@ a32____squeeze_array_ref (out, (W64.of_int 0), 32,
    st, 136);
  ...
  proc _sha3_512A_A64 (out:W8.t Array64.t, in_0:W8.t Array64.t) : W8.t Array64.t = {
    ...
    st <- st_s;
    st <@ __state_init_ref (st);
    (st,  _0,  _1) <@ a64____absorb_array_ref (st, 0, in_0, (W64.of_int 0),
    64, 72, 6);
    (aux, aux_0, aux_1) <@ a64____squeeze_array_ref (out, (W64.of_int 0), 64,
    st, 72);
    out <- aux;
  ...
  proc _i_poly_decompress (rp:W16.t Array256.t, ap:W8.t Array160.t) : 
  W16.t Array256.t = {
    var c0:W8.t;
    var t:W8.t Array8.t;
    var c1:W8.t;
  ...
  proc __polyvec_pointwise_acc (a:W16.t Array1024.t, b:W16.t Array1024.t) : 
  W16.t Array256.t = {
  ...
  proc __i_polyvec_tobytes (rp:W8.t Array1536.t, a:W16.t Array1024.t) : 
  W8.t Array1536.t = {
  ...
  W8.t Array1408.t = {
    var aa:W16.t Array1024.t;
    var k:int;
    var d0:W64.t;
    var t:W16.t Array8.t;
    var c:W16.t;
    var b:W16.t;
    var i:int;
    var j:int;
  ...
  proc __i_polyvec_decompress (rp:W16.t Array1024.t, ap:W8.t Array1408.t) : 
  W16.t Array1024.t = {
    var t0:W32.t;
    var t1:W32.t;
    var d1:W32.t;
  ...
  proc __gen_matrix (seed:W8.t Array32.t, transposed:W64.t) : W16.t Array4096.t = {
    var r:W16.t Array4096.t;
    ...
    while ((i < 4)) {
      ...
      while ((j < 4)) {
        ...
        k <- (W64.of_int 0);
        rij <-
        (Array256.init (fun i_0 => r.[(((i * (4 * 256)) + (j * 256)) + i_0)])
        );
  ...
  proc __indcpa_keypair (pk:W8.t Array1568.t, sk:W8.t Array1536.t,
    ...
    i <- 0;
    while ((i < 4)) {
      aux <@ __polyvec_pointwise_acc ((Array1024.init
                                      (fun i_0 => aa.[((i * (4 * 256)) + i_0)])
                                      ),
      skpv);
      pkpv <-
      (Array1024.init
    ...
    aux_0 <@ __i_polyvec_tobytes ((Array1536.init (fun i_0 => pk.[(0 + i_0)])
                                  ),
    pkpv);
    pk <-
    (Array1568.init
  ...
  W8.t Array1568.t = {
    ...
    v <@ __poly_reduce (v);
    ct <- s_ct;
    aux_0 <@ __i_polyvec_compress ((Array1408.init (fun i => ct.[(0 + i)])),
    bp);
    ct <-
    (Array1568.init
    (fun i => (if (0 <= i < (0 + 1408)) then aux_0.[(i - 0)] else ct.[i])));
    (aux_1, aux) <@ _i_poly_compress ((Array160.init
                                      (fun i => ct.[((4 * 352) + i)])),
    v);
    ct <-
    (Array1568.init
    (fun i => (if ((4 * 352) <= i < ((4 * 352) + 160)) then aux_1.[(i -
                                                                   (4 * 352))] else 
              ct.[i]))
    );
    v <- aux;
  ...
  proc __verify (ctp:W8.t Array1568.t, ctpc:W8.t Array1568.t) : W64.t = {
    var inc:int;
    var cnd:W64.t;
    var i:int;
    var t1:W8.t;
  ...
  proc __crypto_kem_keypair_jazz (pk:W8.t Array1568.t, sk:W8.t Array3168.t,
    ...
    icsk <- (Array1536.init (fun i_0 => sk.[(0 + i_0)]));
    s_skp <- sk;
    (pk, icsk) <@ __indcpa_keypair (pk, icsk, randomnessp1);
    sk <- s_skp;
    sk <-
    (Array3168.init
    (fun i_0 => (if (0 <= i_0 < (0 + 1536)) then icsk.[(i_0 - 0)] else 
                sk.[i_0]))
    );
    inc <- (((4 * 384) + 32) %/ 8);
    i <- 0;
  ...
  proc jade_kem_mlkem_mlkem1024_amd64_ref_keypair_derand (public_key:W8.t Array1568.t,
