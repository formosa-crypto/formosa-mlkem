	...
	.text
	.p2align	5
	.global	_jade_kem_mlkem_mlkem1024_amd64_avx2_gen_matrix
	.global	jade_kem_mlkem_mlkem1024_amd64_avx2_gen_matrix
_jade_kem_mlkem_mlkem1024_amd64_avx2_gen_matrix:
jade_kem_mlkem_mlkem1024_amd64_avx2_gen_matrix:
	movq	%rsp, %rax
	leaq	-48(%rsp), %rsp
	andq	$-32, %rsp
	movq	%rbx, (%rsp)
...
Ljade_kem_mlkem_mlkem1024_amd64_avx2_gen_matrix$1:
	leaq	2168(%rsp), %rsp
	movq	(%rsp), %rbx
	movq	8(%rsp), %rbp
	movq	16(%rsp), %r12
...
L_shake128_next_state$1:
	...
	vpblendd	$195, %ymm4, %ymm1, %ymm6
	vpblendd	$195, %ymm3, %ymm2, %ymm7
	vpblendd	$195, %ymm1, %ymm3, %ymm8
	vpblendd	$240, %ymm7, %ymm6, %ymm1
	vpblendd	$240, %ymm6, %ymm7, %ymm3
	vpblendd	$195, %ymm2, %ymm4, %ymm4
	vpblendd	$240, %ymm8, %ymm4, %ymm2
...
L_keccakf1600_avx2$2:
	...
	vpblendd	$192, %ymm12, %ymm9, %ymm9
	vpblendd	$3, %ymm8, %ymm7, %ymm7
	vpxor	%ymm7, %ymm9, %ymm9
	vpsllvq	glob_data + 384(%rip), %ymm0, %ymm7
	vpsrlvq	glob_data + 192(%rip), %ymm0, %ymm0
	vpor	%ymm7, %ymm0, %ymm0
	vpxor	%ymm9, %ymm1, %ymm1
	vpsllvq	glob_data + 448(%rip), %ymm1, %ymm7
	vpsrlvq	glob_data + 256(%rip), %ymm1, %ymm1
	vpor	%ymm7, %ymm1, %ymm1
	vpxor	%ymm9, %ymm3, %ymm3
	vpsllvq	glob_data + 480(%rip), %ymm3, %ymm7
	vpsrlvq	glob_data + 288(%rip), %ymm3, %ymm3
	vpor	%ymm7, %ymm3, %ymm10
	vpxor	%ymm9, %ymm2, %ymm2
	vpsllvq	glob_data + 512(%rip), %ymm2, %ymm3
	...
	vpsrlvq	glob_data + 352(%rip), %ymm4, %ymm1
	vpor	%ymm0, %ymm1, %ymm8
	vpxor	%ymm9, %ymm5, %ymm0
	vpermq	$27, %ymm10, %ymm5
	vpermq	$114, %ymm2, %ymm9
	vpsllvq	glob_data + 416(%rip), %ymm0, %ymm1
