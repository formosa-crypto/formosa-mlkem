...
int main(void)
{
  ...
  /* TEST KEYPAIR */
  jade_kem_kyber_kyber768_amd64_avx2_keypair(pk1, sk1);
  ...
  jade_kem_kyber_kyber768_amd64_avx2_enc(ct1, shk1, pk1);
  ...
  jade_kem_kyber_kyber768_amd64_avx2_dec(shk1, ct1, sk1);
