...
lemma poly_tobytes_corr _a (_p : address) mem : 
    hoare [ Mprevec.poly_tobytes  :
             pos_bound256_cxq a 0 256 2 /\
             lift_array256 (nttpack a) = _a /\
             valid_ptr _p 384 /\
             Glob.mem = mem /\ to_uint rp = _p
              ==>
             (* 
             ...
             load_array384 Glob.mem _p = encode12 (compress_poly 12 _a)].
admitted.
...
lemma poly_frombytes_corr mem _p (_a : W8.t Array384.t): 
    hoare [ Mprevec.poly_frombytes :
            valid_ptr _p 384 /\
            Glob.mem = mem /\ to_uint ap = _p /\
            load_array384 Glob.mem _p = _a 
            ==>
            Glob.mem = mem /\
            lift_array256 (nttpack res) = decompress_poly 12 (decode12 _a) /\
