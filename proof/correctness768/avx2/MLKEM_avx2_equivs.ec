...
from JazzEC require import Array1152 Array1088 Array960 Array768 Array400 Array384 Array256 Array128 Array64 Array32 Array16 Array4 Array8.
...
lemma polyvec_decompress_equiv :
    equiv [Jkem768_avx2.M.__i_polyvec_decompress ~  Jkem768.M.__polyvec_decompress  :
             rp{1} = ap{2}
              ==>
             ={res} /\
...
equiv compressequivvec_1 mem : 
 Jkem768_avx2.M.__polyvec_compress_1 ~  Jkem768.M.__i_polyvec_compress :
...
lemma poly_decompress_equiv mem _p : 
    equiv [Jkem768_avx2.M._poly_decompress ~  Jkem768.M._poly_decompress  :
             valid_ptr _p 128 /\
...
equiv compressequiv_1 mem : 
 Jkem768_avx2.M._poly_compress_1 ~  Jkem768.M._i_poly_compress :
...
equiv compressequiv mem _p : 
 Jkem768_avx2.M._poly_compress ~  Jkem768.M._poly_compress :
     pos_bound256_cxq a{1} 0 256 2 /\
     pos_bound256_cxq a{2} 0 256 2 /\
    lift_array256 a{1} = lift_array256 a{2} /\ 
...
lemma polyvec_frombytes_equiv :
    equiv [Jkem768_avx2.M.__polyvec_frombytes ~Jkem768.M.__polyvec_frombytes :
...
lemma polyvec_tobytes_equiv :
    forall (_p : int),
    equiv [Jkem768_avx2.M.__polyvec_tobytes ~Jkem768.M.__polyvec_tobytes :
             _p = to_uint rp{1} /\
...
equiv frommsgequiv_noperm  : 
 Jkem768_avx2.M._poly_frommsg_1 ~  Jkem768.M._i_poly_frommsg :
    ={ap} ==> 
    lift_array256 res{1} = lift_array256 res{2} /\
    pos_bound256_cxq res{1} 0 256 1 /\ 
    pos_bound256_cxq res{2} 0 256 1.
...
equiv tomsgequiv_noperm  : 
 Jkem768_avx2.M._poly_tomsg_1 ~  Jkem768.M._i_poly_tomsg :
    lift_array256 a{1} = lift_array256 a{2} /\
    pos_bound256_cxq a{1} 0 256 2 /\ 
    pos_bound256_cxq a{2} 0 256 2 ==>
    res{1}.`1 = res{2}.`1.
