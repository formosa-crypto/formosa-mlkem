...
from JazzEC require import Array1024 Array400 Array384 Array256 Array128 Array64 Array32 Array16 Array4 Array8 Array2.
from JazzEC require import WArray2048 WArray1536 WArray512 WArray32 WArray16.
...
lemma set_get_def1024 (v : W16.t Array1024.t) (w: W256.t) i j :
    0 <= i < 48 => 0 <= j < 1024 =>
    WArray2048.get16
    (WArray2048.set256 (WArray2048.init16 (fun i => v.[i])) i w) j =
      if 16 * i <= j < 16 * i + 16 then w \bits16 (j %% 16)
      else v.[j].
proof.
  move => hx hs; rewrite set256E !get16E.
