...
move : H8; rewrite /ntt_bound_coefs => AA; move : (AA (to_uint (j{2} + len{2})) _); rewrite to_uintD_small; first 3 by smt(@W16).  
...
have ? : (8*Fq.q*Fq.q < R %/ 2 * Fq.q). smt.
split. 
move : H39 H36 H19 H20. 
admit. admit.
