...
(* ----- *) require import Genbindings Mlkem_filter48_bindings.
...
module Filter48 = {
  proc filter48 (buf : W8.t Array56.t, out : W16.t Array40.t) : W16.t Array40.t * W64.t = {
    ...
    f0 <- (VPERMQ (sliceget_8_256_56 buf 0) filter48_permq);
    f1 <- (VPERMQ (sliceget_8_256_56 buf (24 * 8)) filter48_permq);
...
(* -------------------------------------------------------------------- *)
lemma filter48P _buf : hoare[Filter48.filter48 : buf = _buf ==>
  let ws =
    pmap
      (fun i =>
...
] ^shuffle_0<- +12
{
  ...
  f0 <- Mlkem_filter48_bindings.concat_2u128 f0_0 f0_1;
  f1 <- Mlkem_filter48_bindings.concat_2u128 f1_0 f1_1;
}.
...
have extractE: forall f_0 f_1 i k, 0 <= i <= 128 - 16 => 0 <= k < 2 =>
  extract_128_16
    (extract_256_128 (Mlkem_filter48_bindings.concat_2u128 f_0 f_1) (128 * k)) i
