...
lemma mlkem_kem_correct_kg mem _pkp _skp  : 
   equiv [Jkem768_avx2.M(Jkem768_avx2.Syscall).__crypto_kem_keypair_jazz ~ MLKEM.kg_derand : 
...
lemma mlkem_kem_correct_enc mem _ctp _pkp _kp : 
   equiv [Jkem768_avx2.M(Jkem768_avx2.Syscall).__crypto_kem_enc_jazz ~ MLKEM.enc_derand: 
...
wp. conseq />. while(i=1088 /\ inc=1088 /\ #pre); 1: by auto => />. 
+ (*conseq />; 1: by smt(). *)
...
lemma mlkem_kem_correct_dec mem _ctp _skp _shkp : 
   equiv [Jkem768_avx2.M(Jkem768_avx2.Syscall).__crypto_kem_dec_jazz ~ MLKEM.dec: 
