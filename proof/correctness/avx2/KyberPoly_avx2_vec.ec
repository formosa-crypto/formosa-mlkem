...
equiv veceq_poly_tomsg :
  Mvec.poly_tomsg_1 ~ M._poly_tomsg_1: ={rp, a, Glob.mem} ==> ={res}.
proof.
  proc.
...
equiv veceq_poly_frommsg :
  Mvec.poly_frommsg ~ M._poly_frommsg_1: ={rp, ap} ==> ={res}.
proof.
  proc.
...
equiv veceq_poly_decompress:
  Mvec.poly_decompress ~ M._poly_decompress: ={ap, Glob.mem} ==> ={res, Glob.mem}.
proof.
  proc.
...
equiv veceq_poly_compress_1:
  Mvec.poly_compress_1 ~ M._poly_compress_1: ={rp, a, Glob.mem} ==> ={res, Glob.mem}.
proof.
  proc.
...
equiv prevec_eq_poly_tomsg:
  Mprevec.poly_tomsg_1 ~ M._poly_tomsg_1: ={rp, a} ==> ={res}.
...
equiv prevec_eq_poly_frommsg:
  Mprevec.poly_frommsg_1 ~ M._poly_frommsg_1: ={rp, ap}==> ={res}.
...
equiv prevec_eq_poly_decompress:
  Mprevec.poly_decompress ~ M._poly_decompress: ={ap, Glob.mem} ==> ={res, Glob.mem}.
...
equiv prevec_eq_poly_compress_1:
  Mprevec.poly_compress_1 ~ M._poly_compress_1: ={rp, a, Glob.mem} ==> ={res,Glob.mem}.
