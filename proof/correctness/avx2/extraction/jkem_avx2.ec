...
module M(SC:Syscall_t) = {
  ...
  proc __cmov (dst:W8.t Array32.t, src:W64.t, cnd:W64.t) : W8.t Array32.t = {
    ...
    i <- 0;
    while (i < aux) {
      f <- (get256_direct (WArray32.init8 (fun i_0 => dst.[i_0])) (32 * i));
  ...
  proc jade_kem_kyber_kyber768_amd64_avx2r_keypair (public_key:W64.t,
                                                    secret_key:W64.t) : 
  W64.t = {
  ...
  proc jade_kem_kyber_kyber768_amd64_avx2r_enc (ciphertext:W64.t,
                                                shared_secret:W64.t,
  ...
  proc jade_kem_kyber_kyber768_amd64_avx2r_dec (shared_secret:W64.t,
                                                ciphertext:W64.t,
