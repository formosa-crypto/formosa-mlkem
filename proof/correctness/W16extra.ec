...
+ smt(@Int @IntDiv).
+ move => /> *; rewrite mulzC (mulzC xx (yy-65536));apply (aux yy xx) => /#.
...
by move => *; rewrite (_: (- to_uint a) %% 65536 = 65536 - to_uint a) => /> /#.
qed.
