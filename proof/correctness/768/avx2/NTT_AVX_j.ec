...
from Spec require import GFq Correctness768.
...
module Tmp = {
  proc _ntt (rp:W16.t Array256.t) : W16.t Array256.t = {   
    ...
    r6 <- P2R rp 10;
    r7 <- P2R rp 11;
    (r0, r1, r2, r3, r4, r5, r6, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r1, r2, r3, r4,
    ...
    while (i < 2) {
      ...
      (r0, r4) <@Jkem768_avx2.M.__shuffle8 (r0, r4);
      (r1, r5) <@Jkem768_avx2.M.__shuffle8 (r1, r5);
      (r2, r6) <@Jkem768_avx2.M.__shuffle8 (r2, r6);
      (r3, r7) <@Jkem768_avx2.M.__shuffle8 (r3, r7);
      (r0, r4, r1, r5, r2, r6, r3, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r4, r1, r5, r2,
      r6, r3, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      zeta0 <- z2u256 zetasp (40+196*i);
      zeta1 <- z2u256 zetasp (56+196*i);
      (r0, r2) <@Jkem768_avx2.M.__shuffle4 (r0, r2);
      (r4, r6) <@Jkem768_avx2.M.__shuffle4 (r4, r6);
      (r1, r3) <@Jkem768_avx2.M.__shuffle4 (r1, r3);
      (r5, r7) <@Jkem768_avx2.M.__shuffle4 (r5, r7);
      (r0, r2, r4, r6, r1, r3, r5, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r2, r4, r6, r1,
      r3, r5, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      zeta0 <- z2u256 zetasp (72+196*i);
      zeta1 <- z2u256 zetasp (88+196*i);
      (r0, r1) <@Jkem768_avx2.M.__shuffle2 (r0, r1);
      (r2, r3) <@Jkem768_avx2.M.__shuffle2 (r2, r3);
      (r4, r5) <@Jkem768_avx2.M.__shuffle2 (r4, r5);
      (r6, r7) <@Jkem768_avx2.M.__shuffle2 (r6, r7);
      (r0, r1, r2, r3, r4, r5, r6, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r1, r2, r3, r4,
      r5, r6, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      zeta0 <- z2u256 zetasp (104+196*i);
      zeta1 <- z2u256 zetasp (120+196*i);
      (r0, r4) <@Jkem768_avx2.M.__shuffle1 (r0, r4);
      (r1, r5) <@Jkem768_avx2.M.__shuffle1 (r1, r5);
      (r2, r6) <@Jkem768_avx2.M.__shuffle1 (r2, r6);
      (r3, r7) <@Jkem768_avx2.M.__shuffle1 (r3, r7);
      (r0, r4, r1, r5, r2, r6, r3, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r4, r1, r5, r2,
      r6, r3, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      ...
      (r0, r4, r2, r6, r1, r5, r3, r7) <@Jkem768_avx2.M.__butterfly64x (r0, r4, r2, r6, r1,
      r5, r3, r7, zeta0, zeta1, zeta2, zeta3, qx16);
      vx16 <- C2R vx16_op;
      r0 <@Jkem768_avx2.M.__red16x (r0, qx16, vx16);
      r4 <@Jkem768_avx2.M.__red16x (r4, qx16, vx16);
      r2 <@Jkem768_avx2.M.__red16x (r2, qx16, vx16);
      r6 <@Jkem768_avx2.M.__red16x (r6, qx16, vx16);
      r1 <@Jkem768_avx2.M.__red16x (r1, qx16, vx16);
      r5 <@Jkem768_avx2.M.__red16x (r5, qx16, vx16);
      r3 <@Jkem768_avx2.M.__red16x (r3, qx16, vx16);
      r7 <@Jkem768_avx2.M.__red16x (r7, qx16, vx16);
      rp <- PUR rp (0+8*i) r0;
      rp <- PUR rp (1+8*i) r4;
      rp <- PUR rp (2+8*i) r1;
      rp <- PUR rp (3+8*i) r5;
  ...
  proc _invntt (rp:W16.t Array256.t) : W16.t Array256.t = {
    ...
    while (i < 2) {
      ...
      r6 <- P2R rp (6+8*i);
      r7 <- P2R rp (7+8*i);
      (r0, r1, r4, r5, r2, r3, r6, r7) <@Jkem768_avx2.M.__invntt___butterfly64x (r0, r1,
      ...
      r4 <@Jkem768_avx2.M.__red16x (r4, qx16, vx16);
      r5 <@Jkem768_avx2.M.__red16x (r5, qx16, vx16);      
      (r0, r1, r2, r3, r4, r5, r6, r7) <@Jkem768_avx2.M.__invntt___butterfly64x (r0, r1,
      r2, r3, r4, r5, r6, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      (* 4 4 2 2 1 1 1 1 - 0 *)
      (r0, r1) <@Jkem768_avx2.M.__shuffle1 (r0, r1);
      (r2, r3) <@Jkem768_avx2.M.__shuffle1 (r2, r3);
      (r4, r5) <@Jkem768_avx2.M.__shuffle1 (r4, r5);
      (r6, r7) <@Jkem768_avx2.M.__shuffle1 (r6, r7);
      zeta0 <- z2u256 zetasp (96 + (196 * i));
      zeta1 <- z2u256 zetasp (112 + (196 * i));
      (r0, r2, r4, r6, r1, r3, r5, r7) <@Jkem768_avx2.M.__invntt___butterfly64x (r0, r2,
      r4, r6, r1, r3, r5, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      (* 8 1 4 1 2 1 2 1 - 1 *)
      r0 <@Jkem768_avx2.M.__red16x (r0, qx16, vx16);
      (r0, r2) <@Jkem768_avx2.M.__shuffle2 (r0, r2);
      (r4, r6) <@Jkem768_avx2.M.__shuffle2 (r4, r6);
      (r1, r3) <@Jkem768_avx2.M.__shuffle2 (r1, r3);
      (r5, r7) <@Jkem768_avx2.M.__shuffle2 (r5, r7);
      zeta0 <- z2u256 zetasp (128 + (196 * i));
      zeta1 <- z2u256 zetasp (144 + (196 * i));
      (r0, r4, r1, r5, r2, r6, r3, r7) <@Jkem768_avx2.M.__invntt___butterfly64x (r0, r4,
      r1, r5, r2, r6, r3, r7, zeta0, zeta0, zeta1, zeta1, qx16);
      (* 8 2 1 1 4 2 1 1 - 1 *)
      r0 <@Jkem768_avx2.M.__red16x (r0, qx16, vx16);
      (r0, r4) <@Jkem768_avx2.M.__shuffle4 (r0, r4);
      (r1, r5) <@Jkem768_avx2.M.__shuffle4 (r1, r5);
      (r2, r6) <@Jkem768_avx2.M.__shuffle4 (r2, r6);
      (r3, r7) <@Jkem768_avx2.M.__shuffle4 (r3, r7);
      ...
      (* 8 4 2 2 1 1 1 1 - 1 *)
      r0 <@Jkem768_avx2.M.__red16x (r0, qx16, vx16);
      (r0, r1) <@Jkem768_avx2.M.__shuffle8 (r0, r1);
      (r2, r3) <@Jkem768_avx2.M.__shuffle8 (r2, r3);
      (r4, r5) <@Jkem768_avx2.M.__shuffle8 (r4, r5);
      (r6, r7) <@Jkem768_avx2.M.__shuffle8 (r6, r7);
    ...
    while (i < 2) {
      ...
      rp <- PUR rp (10+4*i) r6;
      rp <- PUR rp (11+4*i) r7;
      r0 <@Jkem768_avx2.M.__fqmulprecomp16x (r0, flox16, fhix16, qx16);
      r1 <@Jkem768_avx2.M.__fqmulprecomp16x (r1, flox16, fhix16, qx16);
      r2 <@Jkem768_avx2.M.__fqmulprecomp16x (r2, flox16, fhix16, qx16);
      r3 <@Jkem768_avx2.M.__fqmulprecomp16x (r3, flox16, fhix16, qx16);
      rp <- PUR rp (0+4*i) r0;
      rp <- PUR rp (1+4*i) r1;
      rp <- PUR rp (2+4*i) r2;
      rp <- PUR rp (3+4*i) r3;
  ...
  proc _poly_basemul (rp:W16.t Array256.t, ap:W16.t Array256.t,
    ...
    bre <- P2R bp 0;
    bim <- P2R bp 1;
    (are, aim) <@Jkem768_avx2.M.__schoolbook16x(are, aim, bre, bim, zeta_0, zetaqinv, qx16, qinvx16, 0);
    rp <- PUR rp 0 are;
    rp <- PUR rp 1 aim;
    are <- P2R ap 2;
    aim <- P2R ap 3;
    bre <- P2R bp 2;
    bim <- P2R bp 3;
    (are, aim) <@Jkem768_avx2.M.__schoolbook16x(are, aim, bre, bim, zeta_0, zetaqinv, qx16, qinvx16, 1);
    rp <- PUR rp 2 are;
    rp <- PUR rp 3 aim;
...
Jkem768_avx2.M._poly_basemul ~ Tmp._poly_basemul:
 ={rp,ap,bp} ==> ={res}.
proof.
proc.
...
equiv ntt_avx2_eq_:
Jkem768_avx2.M._poly_ntt ~ Tmp._ntt:
 ={rp} ==> ={res}.
proof.
proc.
sp 0 1.
...
Jkem768_avx2.M._poly_invntt ~ Tmp._invntt:
 ={rp} ==> ={res}.
proof.
proc.
sp 0 1.
...
phoare deinterleave_u16_ph b _x:
 [Jkem768_avx2.M.__w256_deinterleave_u16:
   x16_spec 0 _zero /\
...
phoare interleave_u16_ph b _x:
 [Jkem768_avx2.M.__w256_interleave_u16:
...
lemma fqmulprecomp16x_ll: 
 islossless Jkem768_avx2.M.__fqmulprecomp16x 
by islossless.
...
lemma mont_red_ll:
 islossless Jkem768_avx2.M.__mont_red
by islossless.

hoare mont_red_h _x:
Jkem768_avx2.M.__mont_red:
  x16_spec q qx16 /\
...
Jkem768_avx2.M.__schoolbook16x ~ NTT_AVX.__cmplx_mulx16:
...
Jkem768_avx2.M._poly_basemul ~ NTT_AVX.__basemul:
...
equiv butterfly64x_eq c:
 NTT_AVX.__butterfly64x ~Jkem768_avx2.M.__butterfly64x :
 (c+1)*q <= W16.max_sint /\
...
lemma __shuffle8_ll: islossless Jkem768_avx2.M.__shuffle8 by islossless.

hoare __shuffle8_h na nb _a _b:
Jkem768_avx2.M.__shuffle8:
...
lemma __shuffle4_ll: islossless Jkem768_avx2.M.__shuffle4 by islossless.

hoare __shuffle4_h na nb _a _b:
Jkem768_avx2.M.__shuffle4:
   I16u16_sb na a _a /\ I16u16_sb nb b _b
...
lemma __shuffle2_ll: islossless Jkem768_avx2.M.__shuffle2 by islossless.

hoare __shuffle2_h na nb _a _b:
Jkem768_avx2.M.__shuffle2:
   I16u16_sb na a _a /\ I16u16_sb nb b _b
...
lemma __shuffle1_ll: islossless Jkem768_avx2.M.__shuffle1 by islossless.

hoare __shuffle1_h na nb _a _b:
Jkem768_avx2.M.__shuffle1:
   I16u16_sb na a _a /\ I16u16_sb nb b _b
...
(* Poly reduction *)
lemma __red16x_ll: islossless Jkem768_avx2.M.__red16x by islossless.
...
Jkem768_avx2.M._poly_ntt ~ NTT_AVX.ntt:
