...
from JazzEC require import Safety_mlkem768_ref.
...
lemma a1088____a_ilen_read_upto8_at_proof _buf _b_buf _offset _dELTA _lEN _tRAIL _cUR _aT :
      (a1088____a_ilen_read_upto8_at_spec _buf _b_buf _offset _dELTA 
      _lEN _tRAIL _cUR _aT).
proof.
rewrite /a1088____a_ilen_read_upto8_at_spec .
admitted.

lemma a1088____addstate_ref_proof _st _b_st _aT _buf _b_buf _offset __LEN __TRAILB :
      (a1088____addstate_ref_spec _st _b_st _aT _buf _b_buf _offset __LEN
      __TRAILB).
proof.
rewrite /a1088____addstate_ref_spec .
admitted.

lemma a1088____absorb_ref_proof _st _b_st _aT _buf _b_buf __TRAILB __RATE8 :
      (a1088____absorb_ref_spec _st _b_st _aT _buf _b_buf __TRAILB __RATE8).
proof.
rewrite /a1088____absorb_ref_spec .
admitted.
...
lemma a1184____addstate_ref_proof _st _b_st _aT _buf _b_buf _offset __LEN __TRAILB :
      (a1184____addstate_ref_spec _st _b_st _aT _buf _b_buf _offset __LEN
      __TRAILB).
proof.
rewrite /a1184____addstate_ref_spec .
admitted.

lemma a1184____absorb_ref_proof _st _b_st _aT _buf _b_buf __TRAILB __RATE8 :
      (a1184____absorb_ref_spec _st _b_st _aT _buf _b_buf __TRAILB __RATE8).
proof.
rewrite /a1184____absorb_ref_spec .
  admitted.
...
proc; auto .
ecall (a128____squeeze_ref_proof param_7 b_param_0
      param_6 b_param param_5).
auto .
...
lemma _shake256_A32__A1120_proof _out _b_out _in0 _b_in0 _in1 _b_in1 :
      (_shake256_A32__A1120_spec _out _b_out _in0 _b_in0 _in1 _b_in1).
proof.
rewrite /_shake256_A32__A1120_spec .
proc; auto .
ecall (a32____squeeze_ref_proof param_12 b_param_0
       param_11 b_param param_10).
auto .
ecall (a1088____absorb_ref_proof param_9 b_param_1
       param_8 param_7 (BArray1088.init_arr (W8.of_int 255)) param_6 
       param_5).
auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray32.init_arrP BArray200.init_arrP BArray1088.init_arrP).
qed .
...
proc; auto .
ecall (a64____squeeze_ref_proof param_7 b_param_0
       param_6 b_param param_5).
auto .
ecall (a33____absorb_ref_proof param_4 (BArray200.init_arr (W8.of_int 255)) 
       param_3 param_2 (BArray33.init_arr (W8.of_int 255)) param_1 param_0).
...
proc; auto .
ecall (a32____squeeze_ref_proof param_7 b_param_0
       param_6 b_param param_5).
auto .
ecall (a1184____absorb_ref_proof param_4 (BArray200.init_arr (W8.of_int 255)) 
       param_3 param_2 (BArray1184.init_arr (W8.of_int 255)) param_1 
       param_0).
auto .
ecall (__state_init_ref_proof param b_param_1).
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1184.init_arrP BArray200.init_arrP BArray32.init_arrP).
qed .
...
auto => &m />; smt(BArray33.is_init_set_last valid_cat).
auto => &m />; smt(BArray33.is_init_set_last valid_cat).
qed .
...
auto => &m /> *; smt(valid_cat BArray384.is_init_set_last).
auto .
...
auto => &m />; smt(valid_cat BArray32.is_init_set_last).
auto .
ecall (_poly_csubq_proof param (BArray512.init_arr (W8.of_int 255))).
auto => &m /> *; smt(valid_cat BArray512.init_arrP).
qed .
...
proc; auto .
while ((valid trace__i_poly_compress) /\ 0<=i<=128 /\ BArray128.is_init b_rp 0 i).
auto => &m /> *; smt(valid_cat BArray128.is_init_set_last).
auto .
ecall (_poly_csubq_proof param (BArray512.init_arr (W8.of_int 255))).
auto => &m /> *; smt(valid_cat BArray512.init_arrP).
qed .
...
proc; auto .
while ((valid trace__i_poly_decompress) /\  0<=i<=128 /\ BArray512.is_init b_rp 0 (4*i)).
auto => &m /> *. smt(valid_cat BArray512.is_init_cell_set16d).
auto => &m /> * /#.
qed .
...
proc; auto .
while ((valid trace___i_polyvec_frombytes) /\ 0<=i<=3 /\ BArray1536.is_init b_r 0 (512*i) /\ BArray1152.is_init b_ap 0 1152).
auto .
ecall (_poly_frombytes_proof param_0 b_param_0 param b_param).
auto .
rewrite /is_init /valid /= => &m /> *. 
smt (List.all_cat SBArray1152_384.SBArray1152_384.is_init_cell_get SBArray1536_512.SBArray1536_512.is_init_cell_set BArray512.init_arrP).
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1536.init_arrP).
qed .
...
proc; auto .
while ((valid trace___i_polyvec_tobytes) /\ 0<=i /\ i<=4 /\ BArray1152.is_init b_rp 0 (i*384) /\ BArray1536.is_init b_a 0 1536).
auto .
...
proc; auto .
while ((valid trace___i_polyvec_compress) /\ 0<=i<=768 /\ BArray960.is_init b_rp 0 j /\ j = (i%/4)*5 /\ i%%4 = 0).
auto .
while ((valid trace___i_polyvec_compress) /\ 0<=k /\ BArray32.is_init b_t 0 (k*8) /\ 0<=i<=764).
auto => &m /> *. smt(valid_cat BArray32.is_init_cell_set64d).
auto => &m /> *. smt(valid_cat BArray32.is_init_cell_set64d BArray960.is_init_set_last).
auto .
ecall (__polyvec_csubq_proof param (BArray1536.init_arr (W8.of_int 255))).
auto => &m /> *; smt(valid_cat BArray1536.init_arrP).
qed .
...
proc; auto .
while ((valid trace___i_polyvec_decompress) /\ 0<=i<=768 /\ BArray1536.is_init b_rp 0 (2*i) /\ i%%4 = 0 /\  j = (i%/4) * 5).
auto .
while ((valid trace___i_polyvec_decompress) /\  0<=k<=4 /\  0<=i<=764 /\ BArray1536.is_init b_rp 0 ((i + k) * 2) /\ BArray20.is_init b_t 0 20).
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat).
auto .
while ((valid trace___i_polyvec_decompress) /\ 0<=k<=5 /\ BArray20.is_init b_t 0 (k*4) /\ j =(i%/4) * 5 + k /\ 0<=i<=764 ).
auto.
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat).
auto.
rewrite /is_init /valid /= => &m /> *. split.  smt(). move => *.
 smt(List.all_cat). 
auto .
rewrite /is_init /valid /= .
smt (List.all_cat).
...
proof.
  ...
  proc; auto . 
  while ((valid trace___gen_matrix) /\ 0<=i<=3 /\ BArray4608.is_init b_r 0 (i*1536) /\ BArray34.is_init b_extseed 0 32).
  + auto .
    while ((valid trace___gen_matrix) /\ 0<=i<3 /\ 0<=j<=3 /\ BArray4608.is_init b_r 0 (2 * (i * 768 + j * 256))  /\ BArray34.is_init b_extseed 0 32 ).
    + auto .
      ...
      move => *. split. smt(valid_cat SBArray4608_512.SBArray4608_512.is_init_cell_set).
      move => 3?; rewrite ultE /= => *. smt(valid_cat SBArray4608_512.SBArray4608_512.is_init_cell_set).
    auto => &m /> *; smt(valid_cat).
  auto .
...
ecall (__i_polyvec_tobytes_proof param_18 b_param_0 param_17 (
                                                             ...
                                                             (W8.of_int 255))).
auto .
ecall (__polyvec_reduce_proof param_16 (BArray1536.init_arr (W8.of_int 255))).
auto .
ecall (__polyvec_add2_proof param_15 b_param_1 param_14 (BArray1536.init_arr
                                                        (W8.of_int 255))).
auto .
...
auto .
while((valid trace___indcpa_keypair) /\ 0<=i /\ i<=3 /\ BArray32.is_init b_noiseseed 0 32 /\ BArray32.is_init b_publicseed 0 32 /\ BArray1536.is_init b_e 0 (2*256*i) /\ BArray1536.is_init b_skpv 0 1536).
auto. 
ecall (_poly_getnoise_proof param_8 b_param_7 param_7 b_param_6 param_6).
auto. 
rewrite /is_init /valid /= => &m /> *. 
smt(all_cat BArray512.init_arrP SBArray1536_512.SBArray1536_512.is_init_cell_set).
auto. 
while ((valid trace___indcpa_keypair) /\ 0<=i /\ i<=3 /\  BArray32.is_init b_noiseseed 0 32 /\ BArray32.is_init b_publicseed 0 32  /\ BArray1536.is_init b_skpv  0 (i*2*256)).
auto.
...
move => *; split. smt(valid_cat).
move => *; split. smt().
move => *; split. smt(valid_cat BArray1536.init_arrP).
move => *; split. smt().
move => *; split. smt().
move => *; split. smt(valid_cat BArray4608.init_arrP).
move => *; split. smt(BArray1536.init_arrP).
move => *; split. smt(valid_cat BArray1152.init_arrP SBArray1184_1152.SBArray1184_1152.is_init_cell_set).
smt(BArray1152.init_arrP).
qed .
...
auto .
ecall (__polyvec_reduce_proof param_26 (BArray1536.init_arr (W8.of_int 255))).
auto .
...
auto .
ecall (__polyvec_add2_proof param_21 (BArray1536.init_arr (W8.of_int 255)) 
       param_20 b_param_1).
auto .
...
auto .
ecall (__polyvec_pointwise_acc_proof param_17 (BArray1536.init_arr
...
ecall (_poly_getnoise_proof param_12 b_param_5 param_11 (BArray32.init_arr
       ...
       param_10).
auto .
while ((valid trace___indcpa_enc) /\ 0<=w<=3 /\ BArray1536.is_init b_ep 0 (512*w)).
auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray32.init_arrP BArray512.init_arrP SBArray1536_512.SBArray1536_512.is_init_cell_set).
auto .
while ((valid trace___indcpa_enc) /\ 0<=w<=3 /\ BArray1536.is_init b_sp 0 (512*w)).
auto .
...
auto => &m /> *; split. smt(SBArray1184_1152.SBArray1184_1152.is_init_cell_get).
move => *; split. smt(valid_cat).
...
move => *; split. smt().
move => *; split. smt(BArray128.init_arrP BArray960.init_arrP SBArray1088_128.SBArray1088_128.is_init_cell_set SBArray1088_960.SBArray1088_960.is_init_cell_set).
smt(valid_cat).
qed .
...
auto .
ecall (__polyvec_pointwise_acc_proof param_6 (BArray1536.init_arr
                                             (W8.of_int 255)) param_5 
       (BArray1536.init_arr (W8.of_int 255))).
auto .
ecall (__polyvec_ntt_proof param_4 (BArray1536.init_arr (W8.of_int 255))).
auto .
ecall (__i_polyvec_frombytes_proof param_3 (BArray1152.init_arr
                                           (W8.of_int 255))).
auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
split.  smt(SBArray1088_960.SBArray1088_960.is_init_cell_get).
...
proc; auto .
while ((valid trace___crypto_kem_keypair_jazz) /\ 0<=i /\ i<=4 /\ BArray2400.is_init b_sk 0 ((296+i) *8) /\ BArray32.is_init b_randomnessp2 0 32).
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat ).
auto .
while ((valid trace___crypto_kem_keypair_jazz) /\ 0<=i /\ i<=4  /\ BArray2400.is_init b_sk 0 ((292+ i) *8)).
auto .
rewrite /is_init /valid /=.
smt (List.all_cat).
auto .
...
move => *. smt(BArray1184.init_arrP all_cat BArray64.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get).
qed .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1184.init_arrP BArray32.init_arrP BArray64.init_arrP BArray1088.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get SBArray64_32.SBArray64_32.is_init_cell_set).
qed .
...
ecall (__cmov_proof param_15 (BArray32.init_arr (W8.of_int 255)) param_14 
       b_param param_13).
auto .
ecall (_shake256_A32__A1120_proof param_12 b_param_1 param_11 b_param_0 
       param_10 (BArray1088.init_arr (W8.of_int 255))).
auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
split. smt(BArray1088.init_arrP BArray2400.init_arrP SBArray2400_1152.SBArray2400_1152.is_init_cell_get).
move => *.  split. smt(all_cat BArray32.init_arrP SBArray64_32.SBArray64_32.is_init_cell_set).
move => *.  split. smt().
move => *. split. smt(BArray64.init_arrP BArray2400.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get SBArray2400_1184.SBArray2400_1184.is_init_cell_get).
move => *. split. smt(BArray2400.init_arrP SBArray2400_32.SBArray2400_32.is_init_cell_get).
move => *. smt(all_cat BArray32.init_arrP BArray64.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get).
qed .

lemma jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand_proof _public_key _b_public_key _secret_key _b_secret_key _coins _b_coins :
      (jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand_spec _public_key
      _b_public_key _secret_key _b_secret_key _coins _b_coins).
proof.
rewrite /jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand_spec .
proc; auto .
...
lemma jade_kem_mlkem_mlkem768_amd64_ref_keypair_proof _public_key _b_public_key _secret_key _b_secret_key :
      (jade_kem_mlkem_mlkem768_amd64_ref_keypair_spec _public_key
      _b_public_key _secret_key _b_secret_key).
proof.
rewrite /jade_kem_mlkem_mlkem768_amd64_ref_keypair_spec .
proc; auto .
ecall (jade_kem_mlkem_mlkem768_amd64_ref_keypair_derand_proof param_1 
...
lemma jade_kem_mlkem_mlkem768_amd64_ref_enc_derand_proof _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key _coins _b_coins :
      (jade_kem_mlkem_mlkem768_amd64_ref_enc_derand_spec _ciphertext
      _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key
      _coins _b_coins).
proof.
rewrite /jade_kem_mlkem_mlkem768_amd64_ref_enc_derand_spec .
proc; auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray32.init_arrP BArray1088.init_arrP BArray1184.init_arrP).
qed .

lemma jade_kem_mlkem_mlkem768_amd64_ref_enc_proof _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key :
      (jade_kem_mlkem_mlkem768_amd64_ref_enc_spec _ciphertext _b_ciphertext
      _shared_secret _b_shared_secret _public_key _b_public_key).
proof.
rewrite /jade_kem_mlkem_mlkem768_amd64_ref_enc_spec .
proc; auto .
ecall (jade_kem_mlkem_mlkem768_amd64_ref_enc_derand_proof param_2 b_param_0 
...
lemma jade_kem_mlkem_mlkem768_amd64_ref_dec_proof _shared_secret _b_shared_secret _ciphertext _b_ciphertext _secret_key _b_secret_key :
      (jade_kem_mlkem_mlkem768_amd64_ref_dec_spec _shared_secret
      _b_shared_secret _ciphertext _b_ciphertext _secret_key _b_secret_key).
proof.
rewrite /jade_kem_mlkem_mlkem768_amd64_ref_dec_spec .
proc; auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1088.init_arrP BArray2400.init_arrP BArray32.init_arrP).
qed .
