...
from JazzEC require import Safety_mlkem1024_avx2.
...
lemma _shake256_A128__A32_A1_proof _out _b_out _seed _b_seed _nonce _b_nonce :
      (_shake256_A128__A32_A1_spec _out _b_out _seed _b_seed _nonce _b_nonce).
proof.
rewrite /_shake256_A128__A32_A1_spec .
proc; auto .
ecall (a128____squeeze_avx2_proof param_11 (BArray224.init_arr
                                           (JWord.W8.of_int 255)) param_10 
       b_param param_9).
auto .
ecall (a1____absorb_avx2_proof param_8 (BArray224.init_arr (JWord.W8.of_int 255)) 
       param_7 param_6 (BArray1.init_arr (JWord.W8.of_int 255)) param_5 param_4).
auto .
...
auto .
ecall (__state_init_avx2_proof).
auto => &m /> *; split. smt(BArray32.init_arrP BArray224.init_arrP).
smt(valid_cat BArray1.init_arrP BArray128.init_arrP).
qed .
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat  BArray800.init_arrP BArray32.init_arrP SBArray4_1.SBArray4_1.is_init_cell_get BArray128.init_arrP).
qed .
...
ecall (a32____squeeze_avx2_proof param_6 (BArray224.init_arr (JWord.W8.of_int 255)) 
       param_5 b_param param_4).
auto .
ecall (a1568____absorb_avx2_proof param_3 (BArray224.init_arr (JWord.W8.of_int 255)
                                          ) param_2 param_1 (
                                                            BArray1568.init_arr
                                                            (JWord.W8.of_int 255)) 
       param_0 param).
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray224.init_arrP BArray1568.init_arrP BArray32.init_arrP).
qed .

lemma _shake256_A32__A1600_proof _out _b_out _in _b_in :
      (_shake256_A32__A1600_spec _out _b_out _in _b_in).
proof.
...
ecall (a32____squeeze_avx2_proof param_6 (BArray224.init_arr (JWord.W8.of_int 255)) 
       param_5 b_param param_4).
auto .
ecall (a1600____absorb_avx2_proof param_3 (BArray224.init_arr (JWord.W8.of_int 255)
                                          ) param_2 param_1 (
                                                            BArray1600.init_arr
                                                            (JWord.W8.of_int 255)) 
       param_0 param).
...
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1600.init_arrP BArray224.init_arrP BArray32.init_arrP).
qed .
...
lemma _poly_getnoise_eta2_proof _rp _b_rp _seed _b_seed _nonce :
      (_poly_getnoise_eta2_spec _rp _b_rp _seed _b_seed _nonce).
proof.
rewrite /_poly_getnoise_eta2_spec .
proc; auto .
ecall (__poly_cbd_eta1_proof param_3 b_param param_2 (BArray128.init_arr
                                                     (JWord.W8.of_int 255))).
auto .
ecall (_shake256_A128__A32_A1_proof param_1 b_param_1 param_0 (
                                                              BArray32.init_arr
                                                              (JWord.W8.of_int 255)
                                                              ) param 
       b_param_0).
auto => &m /> *; split. smt(BArray32.init_arrP BArray1.is_init_set_last).
smt(valid_cat BArray128.init_arrP BArray512.init_arrP).
qed .
...
ecall (_shake256x4_A128__A32_A1_proof param_4 b_param_7 param_3 b_param_6 
       ...
       b_param_3).
auto => &m /> *; split. smt(BArray32.init_arrP BArray4.is_init_set_last).
smt(valid_cat BArray128.init_arrP BArray512.init_arrP).
qed .
...
ecall (__invntt___butterfly64x_proof param_11 param_10 param_9 param_8 
       ...
       param).
auto => &m /> *; smt(valid_cat).
auto => &m /> *; smt (BArray512.init_arrP).
qed .
...
proc; auto .
while ((valid trace___i_polyvec_frombytes) /\ 0<=i /\ i<=4 /\ BArray2048.is_init b_r 0 (i*512) /\ BArray1536.is_init b_a 0 1536).
auto .
...
proc; auto .
while ((valid trace___i_polyvec_tobytes) /\ 0<=i /\ i<=4 /\ BArray1536.is_init b_r 0 (i*384) /\ BArray2048.is_init b_a 0 2048).
auto .
...
lemma __i_polyvec_decompress_proof _r _b_r _rp _b_rp :
      (__i_polyvec_decompress_spec _r _b_r _rp _b_rp).
proof.
rewrite /__i_polyvec_decompress_spec .
proc; auto .
while ((valid trace___i_polyvec_decompress) /\ 0<=k /\ k<=4 /\ BArray2048.is_init b_r 0 (k*512)).
auto .
while ((valid trace___i_polyvec_decompress) /\  0<=i /\ i<=16 /\ 0<=k /\ k<4 /\ BArray2048.is_init b_r 0 (32*(16*k + i))).
auto .
rewrite /is_init /valid /=.
smt (List.all_cat).
auto .
...
proof.
  ...
  rewrite !W64.to_uintD_small /=;1..26: smt(W64.of_uintK pow2_64 modz_small).
...
proc; auto .
while ((valid trace__gen_matrix_avx2) /\ 0<= i /\ BArray8192.is_init b_matrix 0 8192).
auto .
while ((valid trace__gen_matrix_avx2) /\  0<=i /\ i<4 /\ 0<= j /\ BArray8192.is_init b_matrix 0 8192).
auto .
ecall (_nttunpack_proof param_4 b_param).
auto .
rewrite /is_init /valid /=.
smt (List.all_cat SBArray8192_512.SBArray8192_512.is_init_cell_set  SBArray8192_512.SBArray8192_512.is_init_cell_get BArray512.init_arrP).
auto .
rewrite /is_init /valid /=.
smt (List.all_cat).
auto .
while ((valid trace__gen_matrix_avx2) /\  BArray8192.is_init b_matrix 0 (i*4*256*2) /\ 0<=i /\ i<=4 /\ 0<= JWord.W64.to_uint transposed /\ JWord.W64.to_uint transposed <=1).
auto .
ecall (_gen_matrix_sample_four_polynomials_proof param_3 b_param_1 param_2 
       b_param_0 param_1 (BArray32.init_arr (JWord.W8.of_int 255)) param_0 
       param).
auto .
rewrite /is_init /valid /= => &m /> *.
  ...
  smt(List.all_cat SBArray8192_2048.SBArray8192_2048.is_init_cell_set BArray2048.init_arrP).
auto. rewrite /is_init /valid /= => &m /> ?. rewrite !JWord.W64.uleE JWord.W64.to_uintK_small /=. smt().
...
auto => &m /> *; smt(valid_cat BArray1568.is_init_cell_set64d).
auto .
...
ecall (__i_polyvec_tobytes_proof param_26 b_param_0 param_25 (
                                                             ...
                                                             (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_reduce_proof param_24 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_add2_proof param_23 b_param_1 param_22 (BArray2048.init_arr
                                                        (JWord.W8.of_int 255))).
auto .
...
ecall (__polyvec_pointwise_acc_proof param_20 b_param_4 param_19 b_param_3 
       param_18 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto => &m /> *; split. smt(BArray2048.init_arrP SBArray8192_2048.SBArray8192_2048.is_init_cell_get).
smt(SBArray2048_512.SBArray2048_512.is_init_cell_get SBArray2048_512.SBArray2048_512.is_init_cell_set BArray512.init_arrP valid_cat).
auto .
...
auto => &m /> *. smt(valid_cat BArray32.is_init_cell_set64d).
auto .
...
auto => &m /> *; split. smt(BArray33.init_arrP).
...
smt(valid_cat BArray1536.init_arrP SBArray1568_1536.SBArray1568_1536.is_init_cell_set).
qed .
...
proc; auto .
ecall (_i_poly_compress_proof param_40 b_param param_39 (BArray512.init_arr
                                                        (JWord.W8.of_int 255))).
auto .
ecall (__i_polyvec_compress_proof param_38 b_param_0 param_37 (
                                                              BArray2048.init_arr
                                                              (JWord.W8.of_int 255)
                                                              )).
auto .
ecall (__poly_reduce_proof param_36 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_reduce_proof param_35 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
ecall (_poly_add2_proof param_34 (BArray512.init_arr (JWord.W8.of_int 255)) 
       param_33 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (_poly_add2_proof param_32 (BArray512.init_arr (JWord.W8.of_int 255)) 
       param_31 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_add2_proof param_30 (BArray2048.init_arr (JWord.W8.of_int 255)) 
       param_29 b_param_1).
auto .
ecall (_poly_invntt_proof param_28 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_invntt_proof param_27 b_param_2).
auto .
ecall (__polyvec_pointwise_acc_proof param_26 b_param_3 param_25 (
                                                                 BArray2048.init_arr
                                                                 (JWord.W8.of_int
                                                                 255)) 
       param_24 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
while ((valid trace___indcpa_enc) /\  0<=w /\ w<=4 /\ BArray2048.is_init b_bp 0 (w*512) /\ BArray8192.is_init b_aat 0 8192 ).
auto .
ecall (__polyvec_pointwise_acc_proof param_23 b_param_5 param_22 b_param_4 
       param_21 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
rewrite /is_init /valid /= => &m /> *.
...
auto .
ecall (__polyvec_ntt_proof param_20 b_param_6).
auto .
ecall (_poly_getnoise_eta2_proof param_19 b_param_7 param_18 (
                                                             BArray32.init_arr
                                                             (JWord.W8.of_int 255)) 
       param_17).
auto .
ecall (_poly_getnoise_eta1_4x_proof param_16 b_param_11 param_15 b_param_10 
       ...
       param_11).
auto .
ecall (_poly_getnoise_eta1_4x_proof param_10 b_param_15 param_9 b_param_14 
       param_8 b_param_13 param_7 b_param_12 param_6 (BArray32.init_arr
                                                     (JWord.W8.of_int 255)) 
       param_5).
auto .
ecall (_gen_matrix_avx2_proof param_4 b_param_17 param_3 b_param_16 param_2).
auto .
ecall (_i_poly_frommsg_proof param_1 b_param_18 param_0 (BArray32.init_arr
                                                        (JWord.W8.of_int 255))).
auto .
...
proc; auto .
ecall (_i_poly_tomsg_proof param_14 b_param param_13 (BArray512.init_arr
                                                     (JWord.W8.of_int 255))).
auto .
ecall (__poly_reduce_proof param_12 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (_poly_sub_proof param_11 b_param_0 param_10 (BArray512.init_arr
                                                   (JWord.W8.of_int 255)) param_9 
       (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (_poly_invntt_proof param_8 (BArray512.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_pointwise_acc_proof param_7 b_param_1 param_6 (
                                                               BArray2048.init_arr
                                                               (JWord.W8.of_int 255
                                                               )) param_5 
       (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__polyvec_ntt_proof param_4 (BArray2048.init_arr (JWord.W8.of_int 255))).
auto .
ecall (__i_polyvec_frombytes_proof param_3 (BArray1536.init_arr
                                           (JWord.W8.of_int 255))).
auto .
ecall (_i_poly_decompress_proof param_2 b_param_3 param_1 b_param_2).
auto .
ecall (__i_polyvec_decompress_proof param_0 b_param_4 param (
                                                            BArray1568.init_arr
                                                            (JWord.W8.of_int 255))).
auto .
rewrite /is_init /valid /= => &m /> *.
smt (List.all_cat BArray1568.init_arrP  BArray1536.init_arrP BArray2048.init_arrP BArray512.init_arrP  BArray32.init_arrP SBArray1568_160.SBArray1568_160.is_init_cell_get ).
qed .
...
proc; auto .
while ((valid trace___crypto_kem_keypair_jazz) /\  0<=i /\ i<=4 /\ BArray3168.is_init b_sk 0 ((392+i) *8)).
auto .
rewrite /is_init /valid /=.
smt (List.all_cat).
auto .
...
auto .
rewrite /is_init /valid /= .
smt (List.all_cat SBArray64_32.SBArray64_32.is_init_cell_get SBArray3168_1536.SBArray3168_1536.is_init_cell_set BArray1536.init_arrP BArray1568.init_arrP  SBArray3168_32.SBArray3168_32.is_init_cell_set BArray32.init_arrP).
qed .
...
ecall (__indcpa_enc_proof param_6 b_param_1 param_5 b_param_0 param_4 
       (BArray1568.init_arr (JWord.W8.of_int 255)) param_3 b_param).
auto .
...
auto .  
rewrite /is_init /valid /= => &m /> *.
split. smt(BArray1568.init_arrP).
move => *. split. smt(BArray32.init_arrP SBArray64_32.SBArray64_32.is_init_cell_set). 
move => *. split. smt(BArray32.init_arrP BArray64.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get SBArray64_32.SBArray64_32.is_init_cell_set).
move => *. split. smt(BArray64.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get).
move => *. smt(all_cat BArray64.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get).
qed.
...
ecall (__cmov_proof param_14 (BArray32.init_arr (JWord.W8.of_int 255)) param_13 
       b_param param_12).
auto .
ecall (_shake256_A32__A1600_proof param_11 b_param_1 param_10 b_param_0).
auto .
ecall (__verify_proof param_9 (BArray1568.init_arr (JWord.W8.of_int 255)) param_8 
       (BArray1568.init_arr (JWord.W8.of_int 255))).
auto .
...
auto .
rewrite /is_init /valid /= => &m /> *.
split. smt(BArray1568.init_arrP SBArray3168_1536.SBArray3168_1536.is_init_cell_get).
move => *. split. smt(BArray32.init_arrP SBArray64_32.SBArray64_32.is_init_cell_set SBArray3168_32.SBArray3168_32.is_init_cell_get).
move => *. split. smt(BArray32.init_arrP BArray64.init_arrP SBArray3168_1568.SBArray3168_1568.is_init_cell_get SBArray64_32.SBArray64_32.is_init_cell_get SBArray64_32.SBArray64_32.is_init_cell_set  SBArray3168_32.SBArray3168_32.is_init_cell_get).
move => *. split. smt(BArray1568.init_arrP SBArray3168_32.SBArray3168_32.is_init_cell_get SBArray1600_32.SBArray1600_32.is_init_cell_set SBArray1600_1568.SBArray1600_1568.is_init_cell_set).
move => *. smt(all_cat BArray64.init_arrP BArray32.init_arrP SBArray64_32.SBArray64_32.is_init_cell_get  SBArray64_32.SBArray64_32.is_init_cell_set SBArray3168_32.SBArray3168_32.is_init_cell_get).
qed.

lemma jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_derand_proof _public_key _b_public_key _secret_key _b_secret_key _coins _b_coins :
      (jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_derand_spec _public_key
      _b_public_key _secret_key _b_secret_key _coins _b_coins).
proof.
rewrite /jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_derand_spec .
proc; auto .
ecall (__crypto_kem_keypair_jazz_proof param_1 b_param_0 param_0 b_param 
       param (BArray64.init_arr (JWord.W8.of_int 255))).
auto .
rewrite /is_init /valid /= .
smt (List.all_cat BArray64.init_arrP BArray1568.init_arrP BArray3168.init_arrP).
qed .

lemma jade_kem_mlkem_mlkem1024_amd64_avx2_enc_derand_proof _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key _coins _b_coins :
      (jade_kem_mlkem_mlkem1024_amd64_avx2_enc_derand_spec _ciphertext
      _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key
      _coins _b_coins).
proof.
rewrite /jade_kem_mlkem_mlkem1024_amd64_avx2_enc_derand_spec .
proc; auto .
ecall (__crypto_kem_enc_jazz_proof param_2 b_param_0 param_1 b_param 
       param_0 (BArray1568.init_arr (JWord.W8.of_int 255)) param (BArray32.init_arr
                                                           (JWord.W8.of_int 255))).
auto .
rewrite /is_init /valid /= .
...
lemma jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_proof _public_key _b_public_key _secret_key _b_secret_key :
      (jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_spec _public_key
      _b_public_key _secret_key _b_secret_key).
proof.
rewrite /jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_spec .
proc; auto .
ecall (__crypto_kem_keypair_jazz_proof param_1 b_param_0 param_0 b_param 
       param (BArray64.init_arr (JWord.W8.of_int 255))).
auto .
...
lemma jade_kem_mlkem_mlkem1024_amd64_avx2_enc_proof _ciphertext _b_ciphertext _shared_secret _b_shared_secret _public_key _b_public_key :
      (jade_kem_mlkem_mlkem1024_amd64_avx2_enc_spec _ciphertext _b_ciphertext
      _shared_secret _b_shared_secret _public_key _b_public_key).
proof.
rewrite /jade_kem_mlkem_mlkem1024_amd64_avx2_enc_spec .
proc; auto .
ecall (__crypto_kem_enc_jazz_proof param_2 b_param_0 param_1 b_param 
       param_0 (BArray1568.init_arr (JWord.W8.of_int 255)) param (BArray32.init_arr
                                                           (JWord.W8.of_int 255))).
...
lemma jade_kem_mlkem_mlkem1024_amd64_avx2_dec_proof _shared_secret _b_shared_secret _ciphertext _b_ciphertext _secret_key _b_secret_key :
      (jade_kem_mlkem_mlkem1024_amd64_avx2_dec_spec _shared_secret
      _b_shared_secret _ciphertext _b_ciphertext _secret_key _b_secret_key).
proof.
rewrite /jade_kem_mlkem_mlkem1024_amd64_avx2_dec_spec .
proc; auto .
