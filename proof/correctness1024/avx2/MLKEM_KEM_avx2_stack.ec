...
from JazzEC require import Jkem1024_avx2_stack.
...
lemma mlkem_kem_correct_kg   : 
   equiv [Jkem1024_avx2_stack.M.jade_kem_mlkem_mlkem1024_amd64_avx2_keypair_derand ~ MLKEM1024.kg_derand : 
...
ecall {1} (sha3_256A_M1568_ph_stack pk0{1}); 1: by inline *; auto => />* /#.  
...
lemma mlkem_kem_correct_enc : 
   equiv [Jkem1024_avx2_stack.M.jade_kem_mlkem_mlkem1024_amd64_avx2_enc_derand ~ MLKEM1024.enc_derand: 
     coins{1} = coins{2} /\
...
wp; ecall {1} (sha3_256A_M1568_ph_stack pk0{1}).
...
lemma verify_correct_h_stack _ctp _ctp1 :
  hoare [Jkem1024_avx2_stack.M.__verify : 
             arg = (_ctp,_ctp1) ==>
             (_ctp = _ctp1 => 
                       res = W64.of_int 0) /\
             (_ctp <> _ctp1 => 
...
lemma verify_ll : islossless Jkem1024_avx2_stack.M.__verify.
proc.
wp.
...
lemma verify_correct_stack _ctp _ctp1 :
  phoare  [Jkem1024_avx2_stack.M.__verify : 
             arg = (_ctp,_ctp1) ==>
             (_ctp = _ctp1 => 
                       res = W64.of_int 0) /\
             (_ctp <> _ctp1 => 
...
lemma cmov_correct_h_stack _dst _src   _cnd  :
   hoare [Jkem1024_avx2_stack.M.__cmov : 
...
lemma cmov_ll_stack : islossless Jkem1024_avx2_stack.M.__cmov by islossless.


lemma cmov_correct_stack _dst _src _cnd:
   phoare [Jkem1024_avx2_stack.M.__cmov : 
        dst=_dst /\   src = _src /\ cnd = _cnd  ==>
             (_cnd = W64.of_int 0 => 
               res = _src) /\
             (_cnd = W64.of_int 1 => 
...
lemma mlkem_kem_correct_dec : 
   equiv [Jkem1024_avx2_stack.M.jade_kem_mlkem_mlkem1024_amd64_avx2_dec ~ MLKEM1024.dec: 
...
wp;ecall{1} (shake256_A32_A1600_ph_stack zp_ct{1}).
conseq />;1: smt().
