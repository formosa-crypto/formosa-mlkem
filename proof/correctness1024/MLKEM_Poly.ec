...
lemma poly_frombytes_corr mem _p (_a : W8.t Array384.t): 
    phoare [Jkem1024.M._poly_frombytes  :
             valid_ptr _p 384 /\
             Glob.mem = mem /\ to_uint ap = _p /\
             load_array384 Glob.mem _p = _a 
              ==>
...
lemma poly_compress_corr_h _a (_p : address) mem : 
    hoare [Jkem1024.M._poly_compress :
             pos_bound256_cxq a 0 256 2 /\
             lift_array256 a = _a /\
             valid_ptr _p 160 /\
             Glob.mem = mem /\ to_uint rp = _p
...
lemma poly_compress_ll : islossless Jkem1024.M._poly_compress.
proc.
...
lemma poly_compress_corr _a (_p : address) mem : 
    phoare [Jkem1024.M._poly_compress :
             pos_bound256_cxq a 0 256 2 /\
             lift_array256 a = _a /\
             valid_ptr _p 160 /\
             Glob.mem = mem /\ to_uint rp = _p
...
lemma poly_decompress_corr_h mem _p (_a : W8.t Array160.t): 
    hoare [Jkem1024.M._poly_decompress  :
             valid_ptr _p 160 /\
             Glob.mem = mem /\ to_uint ap = _p /\
...
lemma poly_decompress_corr mem _p (_a : W8.t Array160.t): 
    phoare [Jkem1024.M._poly_decompress  :
             valid_ptr _p 160 /\
             Glob.mem = mem /\ to_uint ap = _p /\
             load_array160 Glob.mem _p = _a 
              ==>
